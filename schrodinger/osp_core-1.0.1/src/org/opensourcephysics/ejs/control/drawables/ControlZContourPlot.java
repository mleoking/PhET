...
public class ControlZContourPlot extends ControlDrawable2D implements org.opensourcephysics.ejs.control.swing.NeedsPreUpdate {
  ...
  public ControlZContourPlot(Object _visual) {
    super(_visual);
  }
  ...
  protected org.opensourcephysics.display.Drawable createDrawable(Object _drawable) {
    ...
    dataArray = null;
    if(_drawable instanceof ContourPlot) {
      plot = (ContourPlot) _drawable;
  ...
  public void setValue(int _index, Value _value) {
    ...
    case 8 :
      if(levels!=_value.getInteger()) {
        plot.setNumberOfLevels(levels = _value.getInteger());
      }
      break;
    case 9 :

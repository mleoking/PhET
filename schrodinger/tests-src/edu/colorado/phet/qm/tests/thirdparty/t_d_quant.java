package edu.colorado.phet.qm.tests.thirdparty;// Decompiled by Jad v1.5.8f. Copyright 2001 Pavel Kouznetsov.
...
public class t_d_quant extends Applet
    ...
    public void run() {
        ...
        if( (double)System.currentTimeMillis() > 1171490400000D ) {
            g.setColor( Color.white );
            g.drawString( "This applet has expired. Please reload from", 10, 60 );
            g.drawString( "http://www.fen.bilkent.edu.tr/~yalabik/applets/t_d_quant.html", 10, 90 );

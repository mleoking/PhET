...
//        if( change < 0 ) {
            ...
            Point2D.Double urc = new Point2D.Double( vessel.getLocation().getX() + vessel.getWidth(),
                                                     vessel.getLocation().getY() + vessel.getDepth() - vessel.getWaterLevel() / 2 );
...
//                Vector2D v2 = new Vector2D.Double( ds * 0.001, 0 );

...
//TODO-REVIEW This class is part of the view (at least according to the package organization) but it retains model
...
public class DensityCustomObjectMode extends Mode {
    ...
    public function DensityCustomObjectMode( canvas: AbstractDensityAndBuoyancyPlayAreaComponent ) {
        super( canvas );

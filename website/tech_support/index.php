...
<body>
    ...
    <div id="container">
        ...
        <div id="content">
            ...
            <div id="faq">
                <ul id="nav">
                    <li class="faq"><a href="#1">Why can I run some of the simulations but not all?</a></li>

                    <li class="faq"><a href="#2">What are the System Requirements for running PhET simulations?</a></li>

                    <li class="faq"><a href="#3">I have a Macintosh and some of the Java-based simulations do not work as expected.</a></li>

                    <li class="faq"><a href="#4">I use Internet Explorer and the simulations do not run on my computer.</a></li>

                    <li class="faq"><a href="#5">Why donít Flash simulations run on my computer?</a></li>

                    <li class="faq"><a href="#6">What is the ideal screen resolution to run PhET simulations?</a></li>

                    <li class="faq"><a href="#7">I have Windows 2000 and can run Flash simulations but the Java based simulations do not work.</a></li>

                    <li class="faq"><a href="#8">Why do PhET simulations run slower on my laptop than on a desktop?</a></li>

                    <li class="faq"><a href="#9">Why does my computer crash when I run one of the simulations that has sound?</a></li>

                    <li class="faq"><a href="#10">I would like to translate PhET Simulations into another Language. Can this be easily done?</a></li>
            ...
            <h3 id="1" style="margin: 0px 0px -10px 0px;">Why can I run some of the simulations but not all?</h3>
            ...
            <h3 id="2" style="margin: 0px 0px -10px 0px;">What are the System Requirements for running PhET simulations?</h3>
            ...
            Please note that some of our Java-based simulations will run slowly on Macintosh computer systems. Some simulations may not run correctly on Macintosh systems. These simulations can be identified by thetag below them. If you encounter further problems, please contact us with the relevant details. You should also check the minimum system requirements.</p>
            ...
            <h3 id="3" style="margin: 0px 0px -10px 0px;">I have a Macintosh and some of the Java-based simulations do not work as expected.</h3>
            ...
            <h3 id="4" style="margin: 0px 0px -10px 0px;">I use Internet Explorer and the simulations do not run on my computer.</h3>

            <p>orem ipsum dolor sit amet, consectetuer adipiscing elit. Praesent vehicula sodales dui. Integer feugiat augue id diam. Vivamus vitae ante id velit sagittis tincidunt. Aliquam sed orci. Maecenas nibh sapien, commodo vel, tristique in, sodales ut, quam. Sed dolor lorem, condimentum a, ultrices in, rhoncus eu, nisi. Donec nec ipsum et lectus volutpat mattis. Mauris eget dolor. Maecenas auctor, sem a sollicitudin bibendum, urna est fermentum nisi, id vehicula tortor augue at nibh. Donec pulvinar euismod justo. Nunc in turpis. Pellentesque eu purus quis enim pellentesque aliquam. Morbi scelerisque ipsum vel neque. Sed eget magna. Vestibulum dictum, nisi non auctor suscipit, enim sapien pulvinar tellus, sollicitudin cursus libero purus vitae mi. In hac habitasse platea dictumst. Donec vel eros. Maecenas interdum, magna non scelerisque cursus, mi massa sodales diam, a pulvinar magna diam vitae mi. Sed molestie lobortis urna.</p>

            <p><a href="#top"><img src="../images/top.gif" /></a></p>

            <h3 id="5" style="margin: 0px 0px -10px 0px;">Why donít Flash simulations run on my computer?</h3>

            <p>orem ipsum dolor sit amet, consectetuer adipiscing elit. Praesent vehicula sodales dui. Integer feugiat augue id diam. Vivamus vitae ante id velit sagittis tincidunt. Aliquam sed orci. Maecenas nibh sapien, commodo vel, tristique in, sodales ut, quam. Sed dolor lorem, condimentum a, ultrices in, rhoncus eu, nisi. Donec nec ipsum et lectus volutpat mattis. Mauris eget dolor. Maecenas auctor, sem a sollicitudin bibendum, urna est fermentum nisi, id vehicula tortor augue at nibh. Donec pulvinar euismod justo. Nunc in turpis. Pellentesque eu purus quis enim pellentesque aliquam. Morbi scelerisque ipsum vel neque. Sed eget magna. Vestibulum dictum, nisi non auctor suscipit, enim sapien pulvinar tellus, sollicitudin cursus libero purus vitae mi. In hac habitasse platea dictumst. Donec vel eros. Maecenas interdum, magna non scelerisque cursus, mi massa sodales diam, a pulvinar magna diam vitae mi. Sed molestie lobortis urna.</p>

            <p><a href="#top"><img src="../images/top.gif" /></a></p>

            <h3 id="6" style="margin: 0px 0px -10px 0px;">What is the ideal screen resolution to run PhET simulations?</h3>

            <p>orem ipsum dolor sit amet, consectetuer adipiscing elit. Praesent
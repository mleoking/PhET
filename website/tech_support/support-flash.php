...
class FlashSupportPage extends SitePage {
    ...
    function render_content() {
        ...
        print <<<EOT
            ...
            <p>To run the Flash-based simulations you must have Flash 7 (available free) or newer installed on your computer.</p><a href="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash"><img src="../images/get-flash.gif" alt="Get Flash" /></a>
            ...
            <br />
            <a href="/"><img src="../images/flash-error.gif" alt="Image of a Flash error message" /></a></p>
            ...
            <p><a href="#top"><img src="../images/top.gif" alt="Back to the Top" /></a></p>

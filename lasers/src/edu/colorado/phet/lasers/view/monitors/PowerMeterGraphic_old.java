 ...
 * @version $Revision$
 */
public class PowerMeterGraphic_old extends GraphicLayerSet {
    private Paint belowLasingPaint = Color.green;
    private Paint aboveLasingPaint = Color.red;

    public PowerMeterGraphic_old( Component component, LaserModel model, final PartialMirror rightMirror ) throws HeadlessException {
        super( component );

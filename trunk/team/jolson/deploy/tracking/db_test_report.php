<?php
	...
	display_desc("number of times sims have been run, by year, month and day (non-dev)");
	...
	display_query("SELECT COUNT(*) AS users_last_6_months FROM user WHERE DATEDIFF(CURRENT_DATE, last_seen_month) < 6 * 30;");

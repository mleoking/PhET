//  package edu.colorado.phet.electron.gui;

//  import edu.colorado.phet.electron.utils.*;
//  import java.awt.geom.*;
//  import java.awt.*;
//  import javax.swing.*;
//  import edu.colorado.phet.phys2d.*;
//  import edu.colorado.phet.phys2d.propagators.*;
//  import edu.colorado.phet.electron.*;
//  import java.util.*;
//  import edu.colorado.phet.electron.gui.media.*;
//  import java.io.*;
//  import edu.colorado.phet.electron.gui.mouse.*;
...
//  	BufferedImage bi=edu.colorado.phet.electron.utils.ResourceLoader.loadBufferedImage("images/Electron3.GIF",pp,true);
//  	bi=edu.colorado.phet.electron.utils.AlphaFixer.patchAlpha(bi);

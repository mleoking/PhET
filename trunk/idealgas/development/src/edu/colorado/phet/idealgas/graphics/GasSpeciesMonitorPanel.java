 ...
 *
 */
public class GasSpeciesMonitorPanel extends MonitorPanel {
    ...
    private void linkToSpeciesClass( Class speciesClass ) {
        ...
        try {
            aveSpeedMethod = speciesClass.getMethod( "getAveSpeed", new Class[]{} );
            numMoleculesMethod = speciesClass.getMethod( "getNumMolecules", new Class[]{} );

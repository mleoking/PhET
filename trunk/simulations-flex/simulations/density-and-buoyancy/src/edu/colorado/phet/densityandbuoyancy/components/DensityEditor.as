...
public class DensityEditor extends PropertyEditor {
    ...
    public function DensityEditor(property:NumericProperty, minimum:Number, maximum:Number, unit:Unit, densityObject:DensityObject, dataTipClamp:Function,bounds:Bounds) {
        super(property, minimum, maximum, unit, densityObject, dataTipClamp,bounds);
...
//        updateTextBoxEnabled();
    ...
    override protected function createSlider(property:NumericProperty, minimum:Number, maximum:Number, unit:Unit, densityObject:DensityObject, dataTipClamp:Function,bounds:Bounds):SliderDecorator {
        const slider:SliderDecorator = super.createSlider(property, minimum, maximum, unit, densityObject, dataTipClamp,bounds);

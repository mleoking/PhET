...
//        Potential potential = new SimpleGradientPotential( 30 );
        final Potential potential = new ConstantPotential( 0 );
...
//        new GaussianWave( XMESH, YMESH, new Point( (int)( XMESH * 0.85 ), YMESH / 2 ), new Vector2D.Double( 5L, 0.0 ), 0.01 ).initialize( wavefunction );
//        new GaussianWave( XMESH, YMESH, new Point( (int)( XMESH * 0.5), YMESH / 2 ), new Vector2D.Double( 5L, 0.0 ), 0.01 ).initialize( wavefunction );
        new GaussianWave( XMESH, YMESH, new Point( (int)( XMESH * 0.5 ), YMESH / 2 ), new Vector2D.Double( 0.0, 0.0 ), 0.01 ).initialize( wavefunction );
...
//                }
            ...
            lastCenterX = new PositionValue().compute( wavefunction );
//            double barrierX = new PositionValue().compute( wavefunction );
            System.out.println( "new PositionValue().compute( wavefunction ) = " + new PositionValue().compute( wavefunction ) );

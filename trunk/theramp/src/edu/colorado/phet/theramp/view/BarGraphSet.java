...
public class BarGraphSet extends CompositePhetGraphic {
    ...
    public BarGraphSet( RampPanel rampPanel, final RampModel rampModel ) {
        ...
        PhetShapeGraphic energyBackground = new PhetShapeGraphic( getComponent(), new Rectangle( energyX - 5, 0, 5 * 2 + energyWidth, 10000 ), Color.white, new BasicStroke(), Color.black );

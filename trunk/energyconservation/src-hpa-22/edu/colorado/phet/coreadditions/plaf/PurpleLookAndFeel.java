...
public class PurpleLookAndFeel extends MetalLookAndFeel {
    static final Font lucidaFont = new Font( "Lucida Sans", Font.BOLD, 14 );

    static final Color purple = new Color( 210, 195, 255 );
    public static Color LIGHT_PURPLE = new Color( 190, 190, 255 );
...
//        unImage = RescaleOp2.rescaleXMaintainAspectRatio( unImage, checkBoxIconImageWidth );
        ...
        Object[] defaults = {
            ...
            "Spinner.font", new FontUIResource( lucidaFont ),
            "Spinner.background", new ColorUIResource( Color.green ),
            "TextArea.background", new ColorUIResource( LIGHT_PURPLE ),
            "TextArea.foreground", new ColorUIResource( LIGHT_PURPLE )
        };

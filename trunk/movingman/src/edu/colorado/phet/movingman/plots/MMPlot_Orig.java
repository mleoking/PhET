...
//            add( titleLabel );
    ...
    public MMPlot_Orig( String title, final MovingManModule module, final TimeSeries series, MMTimer timer, Color color, Stroke stroke, Rectangle2D.Double inputBox, BufferedGraphicForComponent buffer, double xShift,

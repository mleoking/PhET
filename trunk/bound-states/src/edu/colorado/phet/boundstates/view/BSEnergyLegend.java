...
public class BSEnergyLegend extends PNode {
    ...
    private BSLegendItem _totalEnergyItem;
    private BSLegendItem _potentialEnergyItem;
    ...
    public BSEnergyLegend() {
        ...
        // Total Energy
        _totalEnergyItem = 
            new BSLegendItem( SimStrings.get( "legend.totalEnergy" ), BSConstants.COLOR_SCHEME.getEigenstateNormalColor() );
        _totalEnergyItem.translate( 0, 0 );
        addChild( _totalEnergyItem );
        
        // Potential Energy
        _potentialEnergyItem = 
            new BSLegendItem( SimStrings.get( "legend.potentialEnergy" ), BSConstants.COLOR_SCHEME.getPotentialEnergyColor() );

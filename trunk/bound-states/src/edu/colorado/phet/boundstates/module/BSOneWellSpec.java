...
public class BSOneWellSpec extends BSAbstractModuleSpec {
    ...
    private static final AxisSpec ASYMMETRIC_ENERGY_AXIS_SPEC = 
        new AxisSpec( ASYMMETRIC_ENERGY_RANGE, ASYMMETRIC_ENERGY_TICK_SPACING, ASYMMETRIC_ENERGY_TICK_FORMAT );
    ...
    private static final AxisSpec COULOMB_3D_ENERGY_AXIS_SPEC = 
        new AxisSpec( COULOMB_3D_ENERGY_RANGE, COULOMB_3D_ENERGY_TICK_SPACING, COULOMB_3D_ENERGY_TICK_FORMAT );
    ...
    private static final AxisSpec HARMONIC_OSCILLATOR_ENERGY_AXIS_SPEC = 
        new AxisSpec( HARMONIC_OSCILLATOR_ENERGY_RANGE, HARMONIC_OSCILLATOR_ENERGY_TICK_SPACING, HARMONIC_OSCILLATOR_ENERGY_TICK_FORMAT );

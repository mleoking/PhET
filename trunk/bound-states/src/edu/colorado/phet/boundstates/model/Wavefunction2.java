...
import edu.colorado.phet.boundstates.test.schmidt_lee.BoundException;
...
public class Wavefunction2 {
     ...
     */
    public Wavefunction2( double hb, double xmin, double xmax, int n, int node, BSAbstractPotential potential ) {
...
//         System.out.println("Upper bound not found");
            throw new RuntimeException( "Upper bound not found, node=" + node );
        }
//
// Find lower bound
//
...
//         System.out.println("Lower bound not found");
            throw new RuntimeException( "Lower bound not found, node=" + node );
        }
//
...
//            return en; // Fix by throwing exception
            throw new RuntimeException( "No convergence in binary chop, node=" + node );
        }
//
...
//            return en; // Fix by throwing exception
            throw new RuntimeException( "No convergence in interpolation, node=" + node );
        }
        return en;
    }
...
//
     ...
     */
    private double[] calv( BSAbstractPotential potential ) {
        int i;
        double x, dx;
        double[] v = new double[n];
//      try {

/** Sam Reid*/
package edu.colorado.phet.common_1200.unittests;
 ...
 */
public class TestModelViewTransform2D extends TestCase {
    public void testModelToViewSimple() {
        ...
        assertEquals( new Point( 0, 100 ), transform.modelToView( 0, 0 ) );
        assertEquals( new Point( 100, 0 ), transform.modelToView( 1, 1 ) );
    ...
    public void testToAffineTransform() {
        Rectangle viewBounds = new Rectangle( 10, 10, 20, 20 );
        Rectangle2D.Double modelBounds = new Rectangle2D.Double( -1, -1, 2, 2 );
        ModelViewTransform2D mvt2 = new ModelViewTransform2D( modelBounds, viewBounds );

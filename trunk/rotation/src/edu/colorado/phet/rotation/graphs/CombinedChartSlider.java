 ...
 * @author Sam Reid
 */
public class CombinedChartSlider extends PNode {
     ...
     */
    public CombinedChartSlider( final JFreeChartNode jFreeChartNode, final PNode sliderThumb ) {
     ...
     */
    public void addListener( CombinedChartSlider.Listener listener ) {
        listeners.add( listener );
    }

    private void notifyValueChanged() {
        for( int i = 0; i < listeners.size(); i++ ) {
            CombinedChartSlider.Listener listener = (CombinedChartSlider.Listener)listeners.get( i );

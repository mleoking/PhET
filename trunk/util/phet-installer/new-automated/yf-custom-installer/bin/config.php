<?php
    ...
    define("RIPPER_USER_AGENT",  '"httrack-web-mirror-yf"');
    ...
    // Young & Freedman Installer Note: Some of the bitrock files - such as the
    // executable itself - are maintained in the main installer directory, and
    // some of the YF-specific files are maintained in a separate location.
    // Hence, some of the constants below point to one place and some point to
    // another.
    define("BITROCK_DIR",               file_cleanup_local_filename(PARENT_DIR."BitRock/"));
    define("BITROCK_YF_DIR",            file_cleanup_local_filename(ROOT_DIR."BitRock/"));
    define("BITROCK_BUILDFILE_DIR",     file_cleanup_local_filename(BITROCK_YF_DIR."projects/"));
    ...
    define("BITROCK_WEB_MIRROR_BUILDFILE", file_cleanup_local_filename(BITROCK_BUILDFILE_DIR."young-and-freedman-web-mirror-installer-buildfile.xml"));
    ...
    define("BITROCK_DIST_DIR",          file_cleanup_local_filename(BITROCK_YF_DIR."output/"));

    define("BITROCK_DIST_PREFIX",       BITROCK_PRODUCT_SHORTNAME."-Installer_");

    // File name of the web mirror installer.  Decided to avoid using all
    // the little bits and pieces of names and just put the whole thing here.
    // Hopefully, this is easier to maintain.
    define("BITROCK_WEB_MIRROR_INSTALLER_NAME",  "PhET-Installer-yf_linux.bin");
    ...
    define("DISTRIBUTION_TAG", "young-and-freedman-custom");

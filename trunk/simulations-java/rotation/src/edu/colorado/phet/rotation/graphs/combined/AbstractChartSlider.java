 ...
 * @author Sam Reid
 */
public abstract class AbstractChartSlider extends PNode {
     ...
     */
    public AbstractChartSlider( final PNode sliderThumb ) {
    ...
    protected abstract double getMinRangeValue();

    protected abstract Rectangle2D getDataArea();

    protected abstract Point2D plotToNode( Point2D.Double aDouble );
     ...
     */
    public void addListener( AbstractChartSlider.Listener listener ) {
        listeners.add( listener );
    }

    private void notifyValueChanged() {
        for( int i = 0; i < listeners.size(); i++ ) {
            AbstractChartSlider.Listener listener = (AbstractChartSlider.Listener)listeners.get( i );

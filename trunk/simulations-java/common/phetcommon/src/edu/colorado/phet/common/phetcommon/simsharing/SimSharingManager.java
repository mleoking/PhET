...
public class SimSharingManager {
    ...
    private static String getMachineCookie() throws IOException {
        ...
        boolean madeDirs = phetPersistenceDir.mkdirs(); //TODO this is handled by AbstractPropertiesFile

        //TODO use AbstractPropertiesFile
        ...
        if ( simsharingFile.exists() ) {
            ...
            return p.getProperty( MACHINE_COOKIE_KEY ); //TODO if this property in null, it should be added
        }
        else {
            Properties p = new Properties();

...
public class TestTimeSeriesGraphSetNode {
    ...
    class TestGraphSet extends GraphSuiteSet {
        ...
        public TestGraphSet( PhetPCanvas pSwingCanvas, final TestMotionModel motionModel ) {
            positionGraph = new MinimizableControlGraph( "x", new MotionControlGraph( pSwingCanvas, new ControlGraphSeries( motionModel.getXVariable() ), "Position", -Math.PI * 3, Math.PI * 3, motionModel, true, motionModel.getTimeSeriesModel(), motionModel ) );

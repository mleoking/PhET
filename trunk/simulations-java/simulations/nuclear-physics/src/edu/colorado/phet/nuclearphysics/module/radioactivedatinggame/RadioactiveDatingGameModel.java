...
public class RadioactiveDatingGameModel implements ModelContainingDatableItems {
    ...
    public RadioactiveDatingGameModel()
    {
        ...
        _datableObjects.add(new DatableItem("Trilobyte", "trilobyte_fossil.png", new Point2D.Double(0, -11), 3.5, 0, HalfLifeInfo.convertYearsToMs(500E6), false));
    	...
    	_datableObjects.add(new DatableItem("Fish Fossil", "fish_fossil.png", new Point2D.Double(-15, -8), 7, 0, HalfLifeInfo.convertYearsToMs(10E6), false));
    	_datableObjects.add(new DatableItem("Dead Tree", "tree_dead_no_space.png", new Point2D.Double(23, 2.5), 3, Math.PI/2, HalfLifeInfo.convertYearsToMs(100), true));
    	_datableObjects.add(new DatableItem("Fish Bones", "fish_bones.png", new Point2D.Double(-20, -1.5), 5, 0, HalfLifeInfo.convertYearsToMs(1000), true));
    	_datableObjects.add(new DatableItem("Pottery", "pottery.png", new Point2D.Double(-10, -5.0), 2.8, Math.PI/2, HalfLifeInfo.convertYearsToMs(5000), true));
    	_datableObjects.add(new DatableItem("Rock 1", "rock_1.png", new Point2D.Double(-9.0, 2.5), 3, 0, HalfLifeInfo.convertYearsToMs(1E9), false));
    	_datableObjects.add(new DatableItem("Rock 2", "rock_2.png", new Point2D.Double(-4, -1.5), 1.5, 0, HalfLifeInfo.convertYearsToMs(1E9), false));
    	_datableObjects.add(new DatableItem("Rock 3", "rock_3.png", new Point2D.Double(-22, -14.5), 2.5, 0, HalfLifeInfo.convertYearsToMs(2E9), false));
    	_datableObjects.add(new DatableItem("Rock 4", "rock_4.png", new Point2D.Double(12, -11), 1.5, 0, HalfLifeInfo.convertYearsToMs(2E9), false));
    	_datableObjects.add(new DatableItem("Rock 5", "rock_4.png", new Point2D.Double(6, -4.5), 2, 0, HalfLifeInfo.convertYearsToMs(2E9), false));
    	_datableObjects.add(new DatableItem("Rock 6", "rock_6.png", new Point2D.Double(15, -7.5), 1.5, 0, HalfLifeInfo.convertYearsToMs(3E9), false));
    	_datableObjects.add(new DatableItem("Rock 7", "rock_7.png", new Point2D.Double(20, -15), 2.5, 0, HalfLifeInfo.convertYearsToMs(3E9), false));
    	_datableObjects.add(new DatableItem("Rock 8", "rock_8.png", new Point2D.Double(-13, -11), 2, 0, HalfLifeInfo.convertYearsToMs(3.5E9), false));
    	_datableObjects.add(new DatableItem("Animal Skull 2", "skull_animal_2.png", new Point2D.Double(-8, -14.5), 4.5, 0, HalfLifeInfo.convertYearsToMs(220E6), true));
    	_datableObjects.add(new DatableItem("Human Skull", "skull_human.png", new Point2D.Double(13, -1.5), 2.4, 0, HalfLifeInfo.convertYearsToMs(1000), true));
    	_datableObjects.add(new DatableItem("Wooden Cup", "cup.png", new Point2D.Double(4, -2), 2.0,  -Math.PI / 3, HalfLifeInfo.convertYearsToMs(1000), true));
    	_datableObjects.add(new DatableItem("Bone", "bone.png", new Point2D.Double(7, -15), 4.5, 0, HalfLifeInfo.convertYearsToMs(220E6), false));

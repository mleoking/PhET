...
public class MultiNucleusAlphaDecayCanvas extends PhetPCanvas {
    ...
    // Instance data
    //----------------------------------------------------------------------------
    private MultiNucleusAlphaDecayModel _singleNucleusAlphaDecayModel;
    private AtomicNucleusNode _nucleusNode;
//    private AlphaDecayEnergyChart _alphaDecayEnergyChart; - TODO: JPB TBD - commented out while some details are worked out.
    private PNode _alphaDecayEnergyChart;
    ...
    public MultiNucleusAlphaDecayCanvas(MultiNucleusAlphaDecayModel singleNucleusAlphaDecayModel) {
        ...
        singleNucleusAlphaDecayModel.addListener( new MultiNucleusAlphaDecayModel.Listener(  ){
        ...
        // TODO: JPB TBD - I've put a placeholder here until I work out what to do about the
        // energy chart wanting a specific model.
//        _alphaDecayEnergyChart = new AlphaDecayEnergyChart(singleNucleusAlphaDecayModel, this);
        _alphaDecayEnergyChart = new PText("Place Holder");
        ...
        addComponentListener( new ComponentAdapter() {
            ...
            public void componentResized( ComponentEvent e ) {
                ...
                // TODO: JPB TBD - commented out while I get chart stuff figured out.

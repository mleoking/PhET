...
public class NuclearPhysicsStrings {
    ...
    public static final String TITLE_SINGLE_ATOM_BETA_DECAY_MODULE = NuclearPhysicsResources.getString( "ModuleTitle.SingleAtomBetaDecayModule" );
    public static final String TITLE_MULTI_ATOM_BETA_DECAY_MODULE = NuclearPhysicsResources.getString( "ModuleTitle.MultiAtomBetaDecayModule" );
    ...
    public static final String DECAY_PROPORTIONS_Y_AXIS_LABEL_PERCENT_PRESENT= NuclearPhysicsResources.getString( "DecayProportionsChart.YAxisLabelPercentPresent" );
    public static final String DECAY_PROPORTIONS_Y_AXIS_LABEL_RATIO_C14_TO_C12= NuclearPhysicsResources.getString( "DecayProportionsChart.YAxisLabelRatioC14ToC12" );
    ...
    public static final String METER_MEASURE_OBJECTS = NuclearPhysicsResources.getString( "Meter.MeasureObjects" );
    public static final String METER_HALF_LIFE_EQUALS = NuclearPhysicsResources.getString( "Meter.HalfLifeEquals" );

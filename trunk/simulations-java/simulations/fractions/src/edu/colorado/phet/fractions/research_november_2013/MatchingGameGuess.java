...
public class MatchingGameGuess {
    public MatchingGameGuess( int points, boolean correct, int leftScaleNumerator, int leftScaleDenominator, int rightScaleNumerator, int rightScaleDenominator ) {this.points = points;

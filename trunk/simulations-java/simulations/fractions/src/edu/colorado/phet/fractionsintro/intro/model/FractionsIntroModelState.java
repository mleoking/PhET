...
@Data public class FractionsIntroModelState {
    ...
    public FractionsIntroModelState() {
        ...
        showMixed = false;
        pieSet = new PieSet();
        representation = ChosenRepresentation.PIE;
    }

    public FractionsIntroModelState( ContainerSet containerSet, boolean showReduced, boolean showMixed, PieSet pieSet, int numerator, int denominator, ChosenRepresentation representation ) {
    ...
    public FractionsIntroModelState representation( ChosenRepresentation representation ) { return new FractionsIntroModelState( containerSet, showReduced, showMixed, pieSet, numerator, denominator, representation ); }
    ...
    public FractionsIntroModelState containerSet( ContainerSet containerSet ) { return new FractionsIntroModelState( containerSet, showReduced, showMixed, pieSet, numerator, denominator, representation ); }
}
...
public class SimColors {
    ...
    public final ObservableProperty<Color> background = new CompositeProperty<Color>( new Function0<Color>() {
        public Color apply() {
            return colorScheme.get().getBackground();
        }
    }, colorScheme );
    public final ObservableProperty<Color> saltColor = new CompositeProperty<Color>( new Function0<Color>() {
        public Color apply() {

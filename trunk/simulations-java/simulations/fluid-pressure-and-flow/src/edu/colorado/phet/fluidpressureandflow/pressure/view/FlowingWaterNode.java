...
public class FlowingWaterNode extends PNode {
    public FlowingWaterNode( final TrapezoidPool pool, final Property<Double> flowRatePercentage, final ModelViewTransform transform, final ObservableProperty<Double> liquidDensity ) {
        ...
        addChild( new PhetPPath( getBottomColor( liquidDensity.get() ) ) {{
            ...
            }.observe( flowRatePercentage, pool.waterVolume, liquidDensity );
        }} );
    }
}
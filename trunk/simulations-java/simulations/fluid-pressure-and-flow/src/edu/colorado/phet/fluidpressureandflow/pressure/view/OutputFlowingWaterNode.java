...
public class OutputFlowingWaterNode extends PNode {
    public OutputFlowingWaterNode( final TrapezoidPool pool, final Property<Double> flowRate, final ModelViewTransform transform, final ObservableProperty<Double> liquidDensity, final ObservableProperty<Boolean> faucetEnabled ) {
        addChild( new PhetPPath( getBottomColor( liquidDensity.get() ) ) {{
            ...
            }.observe( flowRate, pool.waterVolume, liquidDensity, faucetEnabled );
        }} );
    }
}
-injars ant_output\jars\balloons.jar
-outjars ant_output\jars\balloons-pro.jar
...
# Keep - Applications. Keep all application classes that have a main method.
-keepclasseswithmembers public class edu.colorado.phet.balloon.BalloonApplet{

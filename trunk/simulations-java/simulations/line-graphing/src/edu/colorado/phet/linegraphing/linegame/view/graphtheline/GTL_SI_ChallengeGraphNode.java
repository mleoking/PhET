 ...
 */
public abstract class GTL_SI_ChallengeGraphNode extends GTL_ChallengeGraphNode {

    public GTL_SI_ChallengeGraphNode( Graph graph, Line answerLine, ModelViewTransform mvt ) {

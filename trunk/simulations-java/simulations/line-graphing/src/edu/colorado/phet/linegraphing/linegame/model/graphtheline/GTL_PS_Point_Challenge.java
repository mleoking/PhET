 ...
 */
public class GTL_PS_Point_Challenge extends Challenge {

    public GTL_PS_Point_Challenge( Line answer, ModelViewTransform mvt ) {
    ...
    @Override public PNode createView( LineGameModel model, GameAudioPlayer audioPlayer, PDimension challengeSize ) {
        return new GTL_PS_Point_ChallengeNode( model, audioPlayer, challengeSize );
    }
}

 ...
 */
public class GTL_SI_Intercept_Challenge extends Challenge {

    public GTL_SI_Intercept_Challenge( Line answer, ModelViewTransform mvt ) {
    ...
    @Override public PNode createView( LineGameModel model, GameAudioPlayer audioPlayer, PDimension challengeSize ) {
        return new GTL_SI_Intercept_ChallengeNode( model, audioPlayer, challengeSize );
    }
}

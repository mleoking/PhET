...
/**
 * View component for a "Place 3 Points" (P3P) challenge.
 * Given an equation in point-slope (PS) form, place 3 points on the line.
 *
...
public class P3P_PS_ChallengeNode extends P3P_ChallengeNode {
    ...
    public P3P_PS_ChallengeNode( final LineGameModel model, final P3P_Challenge challenge, final GameAudioPlayer audioPlayer, PDimension challengeSize ) {
        ...
        challenge.guess.addObserver( new VoidFunction1<Line>() {
            public void apply( Line line ) {
                ...
                guessEquationParent.addChild( new EquationBoxNode( Strings.YOUR_LINE, LineGameConstants.GUESS_COLOR, boxSize,
    ...
    private PNode createEquationNode( Line line, PhetFont font, Color color ) {
        if ( line == null ) {
            return new PhetPText( Strings.NOT_A_LINE, new PhetFont( Font.BOLD, 24 ), color );
        }
        else {
    ...
    private P3P_GraphNode createGraphNode( P3P_Challenge challenge ) {

...
/**
 * Given an equation in point-slope form, graph the matching line by manipulating the point.
 *
 * @author Chris Malley (cmalley@pixelzoom.com)
 */
public class PS_EG_Point_ChallengeNode extends PS_ChallengeNode {
    ...
    private static class ThisGraphNode extends ChallengeGraphNode {
        ...
        public void setAnswerVisible( boolean visible ) {
            ...
            pointManipulatorNode.setVisible( false );
        }
    }
}

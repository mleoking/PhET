...
abstract class PointSlopeDragHandler extends SimSharingDragHandler {
    ...
    @Override protected void endDrag( PInputEvent event ) {
        ...
        // snap to grid
        line.set( new StraightLine( MathUtil.round( line.get().rise ), MathUtil.round( line.get().run ),
                                    MathUtil.round( line.get().x1 ), MathUtil.round( line.get().y1 ),
    ...
    public static class X1Y1DragHandler extends PointSlopeDragHandler {
        ...
        @Override protected void drag( PInputEvent event ) {
            ...
            line.set( new StraightLine( line.get().rise, line.get().run, x1, y1, line.get().color, line.get().highlightColor ) );
        }
    }
    ...
    public static class SlopeDragHandler extends PointSlopeDragHandler {
        ...
        @Override protected void drag( PInputEvent event ) {
            ...
            line.set( new StraightLine( rise, run, line.get().x1, line.get().y1, line.get().color, line.get().highlightColor ) );
        }
    }
}

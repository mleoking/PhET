...
//            double alpha = sphereG
            ...
            double angle2 = new MutableVector2D( sphere.getPosition().getX() - closestPointOnWall.getX(),
            ...
            MutableVector2D displacement = loa.normalize().scale( ( sphere.getRadius() + d ) * 2 );

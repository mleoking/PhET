 ...
 */
public class TemplateApplication extends PhetApplication {
     ...
     */
    public TemplateApplication( PhetApplicationConfig config )
    {
        super( config );
    ...
    public static void main( final String[] args ) {
        ...
        SwingUtilities.invokeLater( new Runnable() {
            ...
            public void run() {
                ...
                TemplateApplication app = new TemplateApplication( config );

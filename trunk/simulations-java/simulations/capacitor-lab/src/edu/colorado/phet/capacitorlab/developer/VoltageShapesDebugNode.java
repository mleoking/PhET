...
public class VoltageShapesDebugNode extends PComposite {
    ...
    public VoltageShapesDebugNode( final DielectricModel model ) {
        ...
        // battery
        {
            ...
            final BatteryShapeFactory shapeFactory = battery.shapeFactory;
        ...
        // voltmeter
        {
            ...
            voltmeter.visible.addObserver( new SimpleObserver() {
                public void update() {
                    positiveTipNode.setVisible( voltmeter.visible.getValue() );
                    negativeTipNode.setVisible( voltmeter.visible.getValue() );
                }
            } );
        }
    }

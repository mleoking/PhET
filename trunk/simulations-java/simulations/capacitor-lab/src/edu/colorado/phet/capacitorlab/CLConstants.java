...
public class CLConstants {
    ...
    public static final Point2D BATTERY_LOCATION = new Point2D.Double( -.130, 0 ); // meters
    ...
    public static final DoubleRange PLATE_SIZE_RANGE = new DoubleRange( .050, .100, .075 ); // meters
    public static final DoubleRange PLATE_SEPARATION_RANGE = new DoubleRange( .010, .050, .020 ); // meters
    public static final double PLATE_THICKNESS = .0015; // meters
    
    public static final DoubleRange DIELECTRIC_CONSTANT_RANGE = new DoubleRange( 1, 5, 1 ); // dimensionless
    public static final DoubleRange DIELECTRIC_OFFSET_RANGE = new DoubleRange( 0, PLATE_SIZE_RANGE.getMax(), 0 ); // meters
    public static final double DIELECTRIC_GAP = 0.001; // meters
    
    public static final double WIRE_THICKNESS = .003; // meters

...
public class MassControl extends PNode {
    public MassControl( final EnergySkateParkBasicsModule module ) {
        ...
        addChild( new VBox( 10, new PhetPText( "Skater Mass", EnergySkateParkBasicsModule.TITLE_FONT ),
                            new HSliderNode( MIN_MASS, MAX_MASS, 90, 5, module.mass, new Property<Boolean>( true ) ) {

...
public class CoffeeModule extends MicrowaveModule {
    ...
    public CoffeeModule() {
        ...
        WaterMolecule[] molecules = new WaterMolecule[MicrowavesConfig.NUM_WATER_MOLECULES_IN_COFFEE_CUP * 10];
        Box2D oven = getMicrowaveModel().getOven();

        for ( int i = 0; i < MicrowavesConfig.NUM_WATER_MOLECULES_IN_COFFEE_CUP; i++ ) {

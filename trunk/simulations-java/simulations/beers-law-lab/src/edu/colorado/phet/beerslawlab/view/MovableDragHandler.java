...
public class MovableDragHandler extends SimSharingDragHandlerOld {
    ...
    public MovableDragHandler( final IUserComponent userComponent, final Movable movable, PNode dragNode, final Function0<Parameter[]> simSharingParametersFunction ) {

...
public class ExampleSubPanel extends JPanel {
    ...
    public ExampleSubPanel() {
        ...
        // Title
        JLabel titleLabel = new JLabel( FitnessStrings.TITLE_EXAMPLE_CONTROL_PANEL );
        ...
        double min = 0;
        double max = 360;
        String label = FitnessStrings.LABEL_ORIENTATION;
        String valuePattern = "##0";
        String units = FitnessStrings.UNITS_ORIENTATION;
    ...
    public void setPosition( Point2D p ) {
        String s = FitnessStrings.LABEL_POSITION + " (" + (int) p.getX() + "," + (int) p.getY() + ")";

...
public class FourierConstants {
    ...
    public static final double FUNDAMENTAL_WAVELENGTH = SPEED_OF_SOUND / FUNDAMENTAL_FREQUENCY; // actual wavelength of fundamental, in meters
    public static final double FUNDAMENTAL_PERIOD = 1000 / FUNDAMENTAL_FREQUENCY; // actual period of fundamental, in milliseconds

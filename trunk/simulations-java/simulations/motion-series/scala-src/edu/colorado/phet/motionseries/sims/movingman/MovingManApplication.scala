...
class MovingManCanvas(model: MotionSeriesModel,
  ...
  override def createBeadNode(b: MovingManBead, t: ModelViewTransform2D, s: String, listener: () => Unit) = new PositionDragBeadNode(b, t, "moving-man/moving-man-standing.gif", "moving-man/moving-man-left.gif", listener, this)
...
class MovingManGameModule(frame: PhetFrame,
        ...
        extends BasicMovingManModule(frame, clock, "moving-man.module.game.title".translate, false, false,
          false, false, -6, false, 0.0, true, MotionSeriesDefaults.forceMotionViewport, MotionSeriesDefaults.fullScreenArea)

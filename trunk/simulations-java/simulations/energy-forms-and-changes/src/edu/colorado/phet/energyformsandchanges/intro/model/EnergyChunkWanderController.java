...
public final class EnergyChunkWanderController {
    ...
    private static final double DISTANCE_AT_WHICH_TO_STOP_WANDERING = 0.1; // In meters, empirically chosen.
    ...
    public EnergyChunkWanderController( ImmutableVector2D startingPoint, ImmutableVector2D destination ) {
    ...
    private void updateVelocity() {
        ImmutableVector2D vectorToDestination = destination.getSubtractedInstance( currentPosition );

...
public class ShapeMassNode extends PNode {
    ...
    // Constructor(s)
    //-------------------------------------------------------------------------
    public ShapeMassNode( final ModelViewTransform mvt, final ShapeMass mass, PhetPCanvas canvas ) {
        this( mvt, mass, DEFAULT_COLOR, canvas, new BooleanProperty( false ) );
    }

    public ShapeMassNode( final ModelViewTransform mvt, final ShapeMass mass, Color fillColor, PhetPCanvas canvas, BooleanProperty massLabelVisibleProperty ) {

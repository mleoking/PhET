 ...
 */
public class MyRulerNode extends PhetPNode {
    ...
    /**
     * Simplified constructor. Creates a good-looking ruler for most situations.
     ...
     * @param distanceBetweenFirstAndLastTick
     *
     * @param insetWidth                 space to the left (and right) of the
    ...
    /**
     * Gets the amount of space that appears to the left (and right) of the
     * first (and last) tick marks.
     */
    ...
    /**
     * Sets the amount of space that appears to the left (and right) of the
     * first (and last) tick marks.
     *
     * @param insetWidth the amount of space that appears to the left (and
     *                   right) of the first (and last) tick marks.
     */
    ...
    /**
     * Sets the major tick label that the units will be placed next to. By
     * default, the units are placed next to the left-most tick label.
     *
    ...
    /**
     * Sets an optional scale for the fonts used in this ruler (default scale is
     * 1.0).  This is useful when embedding the ruler in model coordinates.
     *
     * @param fontScale
     */

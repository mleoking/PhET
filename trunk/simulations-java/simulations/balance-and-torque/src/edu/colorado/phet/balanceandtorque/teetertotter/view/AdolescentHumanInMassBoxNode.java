 ...
 * @author John Blanco
 */
public class AdolescentHumanInMassBoxNode extends MassBoxItem {
    ...
    public AdolescentHumanInMassBoxNode( final TeeterTotterTorqueModel model, final ModelViewTransform mvt, final PhetPCanvas canvas ) {

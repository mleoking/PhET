 ...
 * @author Sam Reid
 */
public class NitrateMolecule extends Compound {
    public NitrateMolecule( double angle, ImmutableVector2D relativePosition ) {
        super( relativePosition );
        constituents.add( new Constituent( new FreeOxygenIonParticle(), parseAngleAndMagnitude( NITROGEN_OXYGEN_SPACING, Math.PI * 2 * 0 / 3.0 + angle ) ) );
        constituents.add( new Constituent( new FreeOxygenIonParticle(), parseAngleAndMagnitude( NITROGEN_OXYGEN_SPACING, Math.PI * 2 * 1 / 3.0 + angle ) ) );
        constituents.add( new Constituent( new FreeOxygenIonParticle(), parseAngleAndMagnitude( NITROGEN_OXYGEN_SPACING, Math.PI * 2 * 2 / 3.0 + angle ) ) );

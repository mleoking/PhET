...
public class WaterMolecule extends Molecule {
    ...
    public WaterMolecule( World world, final ModelViewTransform transform, double x, double y, double vx, double vy, final double theta, VoidFunction1<VoidFunction0> addUpdateListener, ObservableProperty<Double> oxygenCharge, ObservableProperty<Double> hydrogenCharge ) {
        ...
        initAtoms( new Atom( x, y, transform, oxygenRadius, body, 0, 0, oxygenCharge, true ),
                   new Atom( x + 0.5E-10, y + 0.5E-10, transform, hydrogenRadius, body, 0.5E-10, 0.5E-10, hydrogenCharge, false ),
                   new Atom( x - 1E-10, y + 1E-10, transform, hydrogenRadius, body, -0.5E-10, 0.5E-10, hydrogenCharge, false ) );
    }

...
public class SugarAndSaltSolutionsColorScheme {
    ...
    public final Property<Boolean> projectorMode = new Property<Boolean>( false );

    //Colors for the background
    public final ColorSet backgroundColorSet = new ColorSet( background, projectorMode, Color.white );

    //Colors for the salt
    public final ColorSet saltColor = new ColorSet( white, projectorMode, Color.darkGray );
}
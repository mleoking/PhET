...
public class FreeBodyDiagramSuite {
    ...
    public FreeBodyDiagramSuite( final Force1DApplication module ) {
        ...
        try {
            ...
            BufferedImage tearImage = ImageLoader.loadBufferedImage( "/simulations/moving-man/data/moving-man/images/tear-20.png" );
            BufferedImage xImage = ImageLoader.loadBufferedImage( "/simulations/moving-man/data/moving-man/images/x-20.png" );

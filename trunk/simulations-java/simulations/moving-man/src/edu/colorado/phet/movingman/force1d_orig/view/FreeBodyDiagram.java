...
import edu.colorado.phet.movingman.force1d_orig.common_force1d.view.graphics.shapes.Arrow;
import edu.colorado.phet.movingman.force1d_orig.common_force1d.view.phetgraphics.CompositePhetGraphic;
import edu.colorado.phet.movingman.force1d_orig.common_force1d.view.phetgraphics.HTMLGraphic;
import edu.colorado.phet.movingman.force1d_orig.common_force1d.view.phetgraphics.PhetGraphic;
import edu.colorado.phet.movingman.force1d_orig.common_force1d.view.phetgraphics.PhetShapeGraphic;
...
public class FreeBodyDiagram extends CompositePhetGraphic {
    ...
    public FreeBodyDiagram( JPanel component, Force1DApplication module ) {
        super( component );
...
//                System.out.println( name+", y>0" );
    ...
    public class AxesGraphic extends CompositePhetGraphic {
        ...
        public AxesGraphic( Component component ) {
            ...
            Font font = new PhetDefaultFont( Font.PLAIN, 16 );

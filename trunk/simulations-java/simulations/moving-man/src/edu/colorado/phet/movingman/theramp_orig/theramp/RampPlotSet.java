...
import edu.colorado.phet.movingman.theramp_orig.theramp.common.LayoutSet;
import edu.colorado.phet.movingman.theramp_orig.theramp.common.Range2D;
import edu.colorado.phet.movingman.theramp_orig.theramp.model.RampPhysicalModel;
import edu.colorado.phet.movingman.theramp_orig.theramp.model.ValueAccessor;
import edu.colorado.phet.movingman.theramp_orig.theramp.timeseries_ramp.TimeSeries;
import edu.colorado.phet.movingman.theramp_orig.theramp.timeseries_ramp.TimeSeriesModel;
...
import edu.colorado.phet.movingman.theramp_orig.theramp.view.plot.TimePlotSuitePNode;
import edu.colorado.phet.movingman.theramp_orig.theramp.view.plot.TimeSeriesPNode;
...
//    private int chartWidth = TimePlotSuitePNode.DEFAULT_CHART_WIDTH;
    ...
    public RampPlotSet( RampModule module, final RampPanel rampPanel ) {
        ...
        workPlot = createTimePlotSuitePNode( new Range2D( 0, -range, RampModule.MAX_TIME, range ),
                                             TheRampStrings.getString( "energy.work" ), TheRampStrings.getString( "units.joules" ), plotY + plotHeight + plotInset, plotHeight, false );
        ...
        parallelForcePlot = createTimePlotSuitePNode( new Range2D( 0, -1000, RampModule.MAX_TIME, 1000 ),
                                                      TheRampStrings.getString( "forces.parallel" ), TheRampStrings.getString( "units.newtons" ), plotY + plotHeight * 2 + plotInset, plotHeight, true );

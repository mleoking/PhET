 ...
 * @author Sam Reid
 */
public class BoundedToolDragHandler {
    ...
    public void mouseDragged( final PInputEvent event ) {
        ...
        Dimension2D globalDelta = new PDimension( constrained.getX() - lastLocation.getX(), constrained.getY() - lastLocation.getY() );

        //Convert from global to the node parent frame
        globalDelta = node.globalToLocal( globalDelta );
        globalDelta = node.localToParent( globalDelta );

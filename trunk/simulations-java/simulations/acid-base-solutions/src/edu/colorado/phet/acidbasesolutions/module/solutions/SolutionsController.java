...
/**
 * SolutionsController is the controller for SolutionsModule.
...
public class SolutionsController {
    ...
    public SolutionsController( SolutionsModel model, SolutionsCanvas canvas, SolutionsControlPanel controlPanel ) {

...
public class SurfaceControlPanel extends MPVerticalPanel {
    ...
    public SurfaceControlPanel( final Property<SurfaceType> surfaceType ) {
        ...
        add( new MPRadioButton<SurfaceType>( MPStrings.NONE, surfaceType, SurfaceType.NONE ) );
        add( new MPRadioButton<SurfaceType>( MPStrings.ELECTROSTATIC_POTENTIAL, surfaceType, SurfaceType.ELECTROSTATIC_POTENTIAL ) );
        add( new MPRadioButton<SurfaceType>( MPStrings.ELECTRON_DENSITY, surfaceType, SurfaceType.ELECTRON_DENSITY ) );
    }
}

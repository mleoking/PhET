...
public class DefaultGunParticle extends GunParticle {
    ...
    private void createControls() {
        ...
        TitledBorder titledBorder = new TitledBorder( new LineBorder( Color.white, 1, true ), QWIStrings.getString( "gun.velocity" ), TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, new PhetFont( Font.BOLD, 12 ), Color.white ) {

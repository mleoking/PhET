...
//     * **************************************************************
//     */
//    double energy( int Nsites, int sx, int sy, int sz, int[][] nbrs, double[] J, double Bx, double By, double bx, double by, double mx, double my, double mz )
///*
...
//
//            ex += sx[i] * ( sx[nbr1] + sx[nbr2] );
//            ebx -= sx[i] * ( Bx + 0.5 * bx[i] );
//            ey += sy[i] * ( sy[nbr1] + sy[nbr2] );
//            eby -= sy[i] * ( By + 0.5 * by[i] );
//
...
//        double e = J[0] * ex + J[1] * ey + 0.5 * Irot * ez + ebx + eby;
//
//        return ( e );
//    }
//
...
//     * **************************************************************
//     */
//    void dipole_field( int Nsites, float sx, float sy, float xsrc, float ysrc, float xobs, float yobs, double D, double bx1, double by1 )
///*
...
//            rx = (double) ( xobs - xsrc[j] );
//            ry = (double) ( yobs - ysrc[j] );
//            r2 = rx * rx + ry * ry;
...
//     * **************************************************************
//     */
//    void get_demag_fields( int Nsites, double sx, double sy, float x, float y, double D, double bx, double by )
///*
...
//     * **************************************************************
//     */
//    double eground( int nx, int ny, int Nsites, int[][] nbrs, float[] x, float[] y, double[] J, double D, double Bx, double By )
///*
...
//     * **********************************************
//     */
//    void ShowMagField( int Nsites, int nx, int ny, double Dext, float[] x, float[] y, double[] sx, double[] sy, double[] hx, double[] hy )
///*
...
//
//        xx = 0.0;
//        while ( xx > xmin + 1.0 ) { xx -= dx_field; }
//        yy = 0.0;
//        while ( yy > ymin + 1.0 ) { yy -= dy_field; }
//
//        x1 = xx + dx_field;
//        y1 = yy + dy_field;
//        i = 0;

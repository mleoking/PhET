...
public class CollectMultipleCanvas extends PhetPCanvas {

    // TODO: mostly deprecated here. We should share much code with BuildAMoleculeCanvas
    ...
    public CollectMultipleCanvas() {
        ...
        mvt = ModelViewTransform.createSinglePointScaleInvertedYMapping(
                ...
                new Point( (int) Math.round( BuildAMoleculeConstants.STAGE_SIZE.width * 0.32 ),
                           (int) Math.round( BuildAMoleculeConstants.STAGE_SIZE.height * 0.49 ) ),

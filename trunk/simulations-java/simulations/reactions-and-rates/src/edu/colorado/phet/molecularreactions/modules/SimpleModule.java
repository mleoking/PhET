...
public class SimpleModule extends MRModule {
     ...
     */
    public SimpleModule() {
        super( MRConfig.RESOURCES.getLocalizedString( "Module.simpleModuleTitle" ), MRConfig.MOLECULE_SEPARATION_PANE_SIZE );
   ...
   public boolean isTemperatureBeingAdjusted() {
    ...
    private void createWiggleMe() {
        ...
        final MotionHelpBalloon wiggleMe = new MotionHelpBalloon( pCanvas, MRConfig.RESOURCES.getLocalizedString( "Application.wiggleMe" ) );

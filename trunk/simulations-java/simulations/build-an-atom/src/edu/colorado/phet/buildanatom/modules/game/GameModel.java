...
public class GameModel {
    ...
    public GameModel() {
        ...
        timer = new GameTimer( new ConstantDtClock( BuildAnAtomDefaults.MILLISECONDS_BETWEEN_FRAMES, BuildAnAtomDefaults.CLOCK_DT ) );
        ...
        challengeFactory = new BAAFactory();
     ...
     */
    public void startGame( int level, boolean timerVisible, boolean soundEnabled, GameChallenge.ChallengeVisibility challengeVisibility ) {
     ...
     */
    private void initGame( int level, boolean timerVisible, boolean soundEnabled, GameChallenge.ChallengeVisibility challengeVisibility ) {
        setLevel( level );
        setTimerVisible( timerVisible );
        setSoundEnabled( soundEnabled );
        setChallengeVisibility( challengeVisibility );
        setChallenges( challengeFactory.createChallenges( CHALLENGES_PER_GAME, getLevel(), 10, challengeVisibility ) );
    }
...
//            System.out.println( "GameModel.checkGuess correct=" + correct + " reaction=" + reactionString + " challenge=[" + challengeString + "] guess=[" + guessString + "]" );
     ...
     * @param challengeVisibility
     */
    private void setChallengeVisibility( GameChallenge.ChallengeVisibility challengeVisibility) {

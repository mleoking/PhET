...
public class RPALStrings {
    ...
    public static final String LABEL_BEST = RPALResources.getString( "label.best" );
    public static final String LABEL_NEW_BEST = RPALResources.getString( "label.newBest" );
    ...
    public static final String TITLE_GAME_OVER = RPALResources.getString( "title.gameOver" );
}

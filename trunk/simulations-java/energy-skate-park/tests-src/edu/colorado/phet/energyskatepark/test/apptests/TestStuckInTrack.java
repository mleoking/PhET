...
public class TestStuckInTrack {
    ...
    private void start() {
        ...
        energySkateParkApplication.getModule().getEnergySkateParkModel().getSpline( 1 ).translate( 1.2, -1.8 );
//        energySkateParkApplication.getModule().getEnergySkateParkModel().getBody( 0 ).setCMRotation( Math.PI / 2 );
    }
}

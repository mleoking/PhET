...
import edu.colorado.phet.common_movingman.view.phetgraphics.BufferedPhetGraphic;
...
public class BufferedLinePlotOrig implements DataSet.Observer {
    ...
    public BufferedLinePlotOrig( Chart chart, DataSet dataSet, BufferedPhetGraphic bufferedPhetGraphic ) {
        this( chart, dataSet, new BasicStroke( 1 ), Color.black, bufferedPhetGraphic );
    }

    public BufferedLinePlotOrig( Chart chart, DataSet dataSet, Stroke stroke, Paint paint, BufferedPhetGraphic bufferedPhetGraphic ) {
        this.chart = chart;
...
//                jc.paintImmediately( bounds.x, bounds.y, bounds.width, bounds.height );
    ...
    public void repaintAll() {
        ...
        if( generalPath != null ) {
            ...
            graphics2D.setClip( chart.getChartBounds() );

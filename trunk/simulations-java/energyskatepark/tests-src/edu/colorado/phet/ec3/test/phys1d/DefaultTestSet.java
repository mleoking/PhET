...
public class DefaultTestSet {
    ...
    public DefaultTestSet() {
        dualTrackTest = new TestState.SplineTestState( "Dual Track Test", 0, 0.92, 0.0, true );
        ...
        upsideDownLoop = new TestState.SplineTestState( "Upside Down Loop", 0, 0.92, 0.0, true );

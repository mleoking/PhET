...
public class DefaultTestSet {
    ...
    public DefaultTestSet() {
        dualTrackTest = new TestState.SplineTestState( 0, 0.92, 0.0, true );
        ...
        upsideDownLoop = new TestState.SplineTestState( 0, 0.92, 0.0, true );
        upsideDownLoop.addCubicSpline2D( new Point2D.Double[]{new Point2D.Double( 4.560000000000002, 5.269999999999993 ), new Point2D.Double( 3.4899999999999984, 3.1999999999999953 ), new Point2D.Double( 4.999999999999996, 3.3499999999999908 ), new Point2D.Double( 3.1999999999999966, 5.2099999999999875 ), new Point2D.Double( 1.009999999999998, 2.1999999999999984 )} );
        tests.add( upsideDownLoop );

        fallThroughValley = new TestState.SplineTestState( 0, 0.5, 0, true );
        ...
        double w = 1.0;
        fallThroughValley2 = new TestState.FreeFallTestState( 1, 0, 0, 0 );
        ...
        fallThroughPeak = new TestState.SplineTestState( 0, 0.92, 0.0, true );
        ...
        fallOffSteep = new TestState.SplineTestState( 0, 0.92, 0.0, true );
        ...
        testApproachPeak = new TestState.SplineTestState( 0, 0.91075, 0, true );

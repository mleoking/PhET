...
public class RenderJPanel extends JPanel implements RenderablePanel {
   ...
   public RenderJPanel() {
      ...
      MouseWheelHandler mwh = new MouseWheelHandler(this);
   ...
   private static final long serialVersionUID = -931693572616469539L;
   //***************************************************************************
   ...
   protected class MouseWheelHandler implements MouseWheelListener {
     ...
     public MouseWheelHandler(RenderJPanel r) {
        rp = r;
     }

     public void mouseWheelMoved(MouseWheelEvent mwe) { 
       rp.mouseWheelMoved(mwe, mwe.getWheelRotation());      
     }
   }      

...
public class idx3d_Object extends idx3d_CoreObject
{
	...
	// D A T A  S T R U C T U R E S
		...
		public void rebuild()
		{
			...
			for (int i=vertices-1;i>=0;i--) vertex[i]=(idx3d_Vertex)enum.nextElement();
			...
			{
				triangle[i]=(idx3d_Triangle)enum.nextElement();
				triangle[i].id=i;
			}
		...
		public void removeDuplicateVertices()
		{
			...
			while(enum.hasMoreElements()) edgeCollapse((idx3d_Edge)enum.nextElement());

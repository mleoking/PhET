...
//        JGVPanel jgvPanel = new JGVPanel( this );
    ...
    public static void main( String[] args ) throws Exception {
        ...
        System.out.println( "cubeXML = " + cubeXML );

        MyGeomOff g = new MyGeomOff();
        g.addVertex( -0.5, -0.5, -0.5 );
        g.addVertex( 0.5, -0.5, -0.5 );
        g.addVertex( 0.5, 0.5, -0.5 );
        g.addVertex( -0.5, 0.5, -0.5 );
        g.addVertex( -0.5, -0.5, 0.5 );
        ...
        g.addFace( new double[]{3, 2, 1, 0}, Color.green );
        g.addFace( new double[]{4, 5, 6, 7}, Color.blue );
        g.addFace( new double[]{2, 3, 7, 6}, Color.red );
        g.addFace( new double[]{0, 1, 5, 4}, Color.orange );
        g.addFace( new double[]{0, 4, 7, 3}, Color.gray );
        g.addFace( new double[]{1, 2, 6, 5}, Color.yellow );
    }

    static String cubeXML = "<?xml version=\"1.0\" encoding=\"UTF-8\" ?>\n" +
                            "<geom>\n" +
    ...
    private static class MyGeomOff {
        public void addVertex( double x, double y, double z ) {
        }

        public void addFace( double[] doubles, Color green ) {
        }

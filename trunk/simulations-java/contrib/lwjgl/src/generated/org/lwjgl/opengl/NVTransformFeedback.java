...
public final class NVTransformFeedback {
	...
	public static void glTransformFeedbackAttribsNV(IntBuffer attribs, int bufferMode) {
		...
		nglTransformFeedbackAttribsNV(attribs.remaining(), MemoryUtil.getAddress(attribs), bufferMode, function_pointer);
	}
	static native void nglTransformFeedbackAttribsNV(int attribs_count, long attribs, int bufferMode, long function_pointer);

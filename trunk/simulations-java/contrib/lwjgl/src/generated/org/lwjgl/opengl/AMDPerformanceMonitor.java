...
public final class AMDPerformanceMonitor {
	...
	public static void glGetPerfMonitorCountersAMD(int group, IntBuffer numCounters, IntBuffer maxActiveCounters, IntBuffer counters) {
		...
		nglGetPerfMonitorCountersAMD(group, MemoryUtil.getAddress(numCounters), MemoryUtil.getAddress(maxActiveCounters), counters.remaining(), MemoryUtil.getAddress(counters), function_pointer);
	}
	...
	public static void glGetPerfMonitorGroupStringAMD(int group, IntBuffer length, ByteBuffer groupString) {
		...
		nglGetPerfMonitorGroupStringAMD(group, groupString.remaining(), MemoryUtil.getAddressSafe(length), MemoryUtil.getAddress(groupString), function_pointer);
	}
	...
	public static void glGetPerfMonitorCounterStringAMD(int group, int counter, IntBuffer length, ByteBuffer counterString) {
		...
		nglGetPerfMonitorCounterStringAMD(group, counter, counterString.remaining(), MemoryUtil.getAddressSafe(length), MemoryUtil.getAddress(counterString), function_pointer);
	}

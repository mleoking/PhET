...
JNIEXPORT jint JNICALL Java_org_lwjgl_opencl_CL11_nclEnqueueReadBufferRect(JNIEnv *env, jclass clazz, jlong command_queue, jlong buffer, jint blocking_read, jlong buffer_origin, jlong host_origin, jlong region, jlong buffer_row_pitch, jlong buffer_slice_pitch, jlong host_row_pitch, jlong host_slice_pitch, jlong ptr, jint num_events_in_wait_list, jlong event_wait_list, jlong event, jlong function_pointer) {
	const size_t *buffer_origin_address = (const size_t *)(intptr_t)buffer_origin;
	const size_t *host_origin_address = (const size_t *)(intptr_t)host_origin;
...
JNIEXPORT jint JNICALL Java_org_lwjgl_opencl_CL11_nclEnqueueWriteBufferRect(JNIEnv *env, jclass clazz, jlong command_queue, jlong buffer, jint blocking_write, jlong buffer_origin, jlong host_origin, jlong region, jlong buffer_row_pitch, jlong buffer_slice_pitch, jlong host_row_pitch, jlong host_slice_pitch, jlong ptr, jint num_events_in_wait_list, jlong event_wait_list, jlong event, jlong function_pointer) {
	const size_t *buffer_origin_address = (const size_t *)(intptr_t)buffer_origin;
	const size_t *host_origin_address = (const size_t *)(intptr_t)host_origin;
	const size_t *region_address = (const size_t *)(intptr_t)region;

...
/**
 * Class implementing a circular tile. This is a fixed object in the world
 * with a circular surface that primitives/particles can collide with.
 * <p/>
 * <pre>
 * JADE - JAva Dynamics Engine
 * Release 0.6.1 alpha 2005-12-28
...
public class CircleTile extends AbstractTile implements Surface {
    ...
    public CircleTile( double cx, double cy, double r ) {
        super( cx, cy );
    ...
    private boolean isRectangleColliding( RectangleParticle p ) {
        ...
        boolean isInVertexX = Math.abs( depthX ) < radius;
        boolean isInVertexY = Math.abs( depthY ) < radius;

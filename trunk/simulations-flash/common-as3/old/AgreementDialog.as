...
class edu.colorado.phet.flashcommon.old.AgreementDialog extends CommonDialog {
	...
	public function AgreementDialog() {
        super( "agreement", _level0.SimStrings.get( "PhetSoftwareAgreement", "PhET Software Agreement" ) );

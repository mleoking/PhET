define( ['view/easel-create',
         'image!resources/house.png',
         'image!resources/mountains.png'],
    function ( EaselExtensions, houseImage, mountainImage ) {
    ...
    var result = {createBackground: function ( groundHeight ) {
        ...
        background.addChild(
            createjs.Shape.create({
                graphics: function(g) {
                    g.beginFill( "#64aa64" )
                     .rect( -extentOutsideOfNominalBounds, 768 - groundHeight, 1024 + 2 * extentOutsideOfNominalBounds, groundHeight + 500 );
                }
            })
        );

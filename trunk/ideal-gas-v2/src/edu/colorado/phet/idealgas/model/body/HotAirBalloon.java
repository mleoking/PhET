...
public class HotAirBalloon extends HollowSphere {
     ...
     * @return
     */
    public boolean isInContactWithParticle( edu.colorado.phet.idealgas.model.body.IdealGasParticle particle ) {
     ...
     * @return
     */
    public boolean isInOpening( edu.colorado.phet.idealgas.model.body.IdealGasParticle particle ) {

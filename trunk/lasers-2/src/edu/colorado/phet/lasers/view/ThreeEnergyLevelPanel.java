...
public class ThreeEnergyLevelPanel extends MonitorPanel {
//public class ThreeEnergyLevelPanel extends JPanel implements Observer {
...
//        PhetApplication.instance().getPhysicalSystem().addObserver( this );
    ...
    protected synchronized void paintComponent( Graphics graphics ) {
        ...
        for( int i = 0; i < numGroundLevel; i++ ) {
            g2.fillArc( (int) ( s_groundLevelLineOriginX + ( s_atomDiam * ( i + 1 ) ) ),
        ...
        for( int i = 0; i < numMiddleLevel; i++ ) {
            g2.fillArc( (int) ( s_middleLevelLineOriginX + ( s_atomDiam * ( i + 1 ) ) ),
        ...
        for( int i = 0; i < numHighLevel; i++ ) {
            g2.fillArc( (int) ( s_highLevelLineOriginX + ( s_atomDiam * ( i + 1 ) ) ),

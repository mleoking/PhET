<?php
	...
	define("PHET_RIPPER_FILTER",        		'"+*phet.colorado.edu/new*" "+*phet.colorado.edu/Design*" "+*phet.colorado.edu/physics*" "+*phet.colorado.edu/simulations*" "+*phet.colorado.edu/sims*" "-*admin/get-upload.php?contribution_file_id=*" "-*teacher_ideas/view-contribution.php*" "-*admin/download-archive.php*" "-*simulations/search.php*" "-*admin/get-run-offline.php*" ');

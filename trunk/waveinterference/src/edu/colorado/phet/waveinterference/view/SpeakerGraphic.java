...
public class SpeakerGraphic extends PNode {
    private Oscillator oscillator;
    private LatticeScreenCoordinates latticeScreenCoordinates;

    public SpeakerGraphic( Oscillator oscillator, LatticeScreenCoordinates latticeScreenCoordinates ) {
        this.oscillator = oscillator;
        this.latticeScreenCoordinates = latticeScreenCoordinates;
        PImage image = PImageFactory.create( "images/speaker.gif" );
        addChild( image );

...
public class CockpitControlPanel extends JPanel {
    ...
    // Inner Classes
    //
    class ParallaxPanel extends JPanel {
        ...
        public ParallaxPanel() {
            ...
            BevelBorder baseBorder = (BevelBorder)BorderFactory.createRaisedBevelBorder();
            Border titledBorder = BorderFactory.createTitledBorder( baseBorder, "Parallax" );
            this.setBorder( titledBorder );

            parallaxReticleBtn = new JButton( new AbstractAction( "Show Reticle" ) {
                boolean reticleOn = false;

                public void actionPerformed( ActionEvent e ) {
                    reticleOn = !reticleOn;
                    module.setParallaxReticleOn( reticleOn );
                    parallaxReticleBtn.setText( reticleOn ? "Hide Reticle" : "Show Reticle" );
                }
            } );

            final JTextField leftRightTF = new JTextField( "0", 6 );
            leftRightTF.setEditable( false );
            leftRightTF.setBackground( Color.white );
            leftRightTF.setHorizontalAlignment( JTextField.RIGHT );

            final JSlider leftRightSlider = new JSlider( -100, 100, 0 );
            ...
            leftRightSlider.addChangeListener( new ChangeListener() {
                ...
                public void stateChanged( ChangeEvent e ) {
                    ...
                    double d = (double)( parallaxCurr - parallaxRef ) / 100;
            ...
            JButton markBtn = new JButton( new AbstractAction( "Mark" ) {
                public void actionPerformed( ActionEvent e ) {
            ...
            final JButton computeBtn = new JButton( new AbstractAction( "Compute" ) {
                public void actionPerformed( ActionEvent e ) {
                    double b = Double.parseDouble( leftRightTF.getText() );

                }
            } );
            computeBtn.setEnabled( false );

            final JTextField reticleTF = new JTextField( 6 );
            reticleTF.setHorizontalAlignment( JTextField.RIGHT );
            reticleTF.getDocument().addDocumentListener( new DocumentListener() {
                public void changedUpdate( DocumentEvent e ) {
                    computeBtn.setEnabled( !reticleTF.getText().equals( "" ) );
                }
...
//                                                  GridBagConstraints.CENTER );
                ...
                GraphicsUtil.addGridBagComponent( this, new JLabel( "Enter reticle offset:" ),
                                                  ...
                                                  GridBagConstraints.NONE,
                                                  GridBagConstraints.CENTER );
                GraphicsUtil.addGridBagComponent( this, reticleTF,
                                                  1, rowIdx++, 1, 1,
                                                  GridBagConstraints.NONE,
                                                  GridBagConstraints.CENTER );
    ...
    private class BrightnessPanel extends JPanel {
        ...
        private boolean reticleOn = false;
...
//        private JTextField brightnessTF;
        ...
        public BrightnessPanel() {
            ...
            BevelBorder baseBorder = (BevelBorder)BorderFactory.createRaisedBevelBorder();
            Border titledBorder = BorderFactory.createTitledBorder( baseBorder, "Brightness" );
            this.setBorder( titledBorder );
            ...
            final SimpleObserver photometerObserver = new SimpleObserver() {
                public void update() {
                    ...
                    boolean starInPhotometer = false;
                    for( int i = 0; i < visibleStars.size(); i++ ) {
                        ...
                        if( module.getPhotometerReticle().contains( starView.getLocation( star ) )) {
                            starInPhotometer = true;
                        }
                    }
                    brightnessTF.setText( starInPhotometer ? "!!!" : "" );
                }
            };
...
//                        }
//                    }
//                    System.out.println( "b: " + module.getPhotometerReticleBounds().getBounds2D().getMinX() + "  " +
//                                        +module.getPhotometerReticleBounds().getBounds2D().getMinY() );
////                    List stars = starView.getStarsIn( module.getPhotometerReticleBounds() );
//                    System.out.println( "stars: " + stars.size() );

            brightnessReticleBtn = new JButton( new AbstractAction( "Show Reticle" ) {
                public void actionPerformed( ActionEvent e ) {
                    reticleOn = !reticleOn;
                    module.setPhotometerReticle( reticleOn );
                    brightnessReticleBtn.setText( reticleOn ? "Hide Reticle" : "Show Reticle" );
                    if( reticleOn ) {
                        module.getPhotometerReticle().getPhotometer().addObserver( photometerObserver );
//                        module.getModel().addModelElement( photometerObserver );
                    }
                    else {
                        module.getPhotometerReticle().getPhotometer().removeObserver( photometerObserver );
//                        module.getModel().removeModelElement( reticleME );
                    }
                }
            } );

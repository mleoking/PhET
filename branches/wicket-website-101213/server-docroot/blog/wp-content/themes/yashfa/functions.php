...
function J_ShowRecentPosts( ) {
    ?>
<div class="last">
<h3><span><?php _e( 'Latest Post', 'yashfa' );?></span> <span
        class="infopost"><?php previous_posts_link( __( 'Previous //', 'yashfa' ) ) ?> <?php next_posts_link( __( 'More', 'yashfa' ) ) ?></span>
</h3>
        <ul class="recent">
        <?php
        if ( is_home( ) ):
        ...
        <?php while ( $wp_query->have_posts( ) ) : $wp_query->the_post( ); ?>
            <li><a href="<?php the_permalink( ) ?>"
                   rel="bookmark"><?php the_title( ); ?></a> <?php the_time( 'd m' ); ?></li>
        <?php endwhile; ?>
        </ul>
...
define( 'HEADER_IMAGE', '%s/images/blog-4.png' ); // %s is theme dir uri
...
function list_comment( $comment, $args, $depth ) {
    ...
    <li <?php comment_class( ); ?> id="comment-<?php comment_ID( ) ?>">
        <div id="div-comment-<?php comment_ID( ) ?>" class="thechild">
            ...
            <div class="cright">
                <div class="comment-author vcard by"> <?php printf( '<span class="fn">%s</span>', get_comment_author_link( ) ) ?>
                ...
                <!--	<span class="numero">--><?php //global $cmntCnt; ?><!---->
                <?php //echo $cmntCnt+1; ?><!----><?php //$cmntCnt = $cmntCnt + 1; ?>
                </span>

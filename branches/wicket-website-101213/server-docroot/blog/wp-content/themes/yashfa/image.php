        ...
        <?php if ( have_posts( ) ) : while ( have_posts( ) ) : the_post( ); ?>
            ...
            <div class="post" id="post-<?php the_ID( ); ?>">
                <h2><a href="<?php echo get_permalink( $post->post_parent ); ?>"
                       rev="attachment"><?php echo get_the_title( $post->post_parent ); ?></a> &raquo; <?php the_title( ); ?>
                </h2>

                <div class="entry">
                    <p class="attachment"><a
                            href="<?php echo wp_get_attachment_url( $post->ID ); ?>"><?php echo wp_get_attachment_image( $post->ID, __( 'medium', 'yashfa' ) ); ?></a>
                    </p>
                ...
                <?php the_content( '<p class="serif">', __( 'Read the rest of this entry &raquo;', 'yashfa' ), '</p>' ); ?>
                    ...
                    <p class="postmetadata alt">
                        <small>
                        <?php _e( 'This entry was posted on ', 'yashfa' );?><?php the_time( 'l, F jS, Y' ) ?>
                            at <?php the_time( ) ?>
                        ...
                        <?php if ( ( 'open' == $post-> comment_status ) && ( 'open' == $post->ping_status ) ) {
                            ...
                            ?>
                            <?php _e( 'You can ', 'yashfa' ); ?><a
                                    href="#respond"><?php _e( 'leave a response', 'yashfa' );?></a><?php _e( ', or ', 'yashfa' ); ?>
                                <a href="<?php trackback_url( ); ?>"
                                   rel="trackback"><?php _e( 'trackback', 'yashfa' );?></a><?php _e( 'from your own site.', 'yashfa' ); ?>

...
// fonctions moteur
int   __cdecl httrackengine_check(httrackp *opt, const char* adr,const char* fil,int status);
int   __cdecl httrackengine_check_mime(httrackp *opt, const char* adr,const char* fil,const char* mime,int status);
...
int   __cdecl httrackengine_htmlpreprocess(httrackp *opt, char** html,int* len,const char* url_address,const char* url_file);
int   __cdecl httrackengine_htmlpostprocess(httrackp *opt, char** html,int* len,const char* url_address,const char* url_file);
int   __cdecl httrackengine_htmlcheck(httrackp *opt, char* html,int len,const char* url_address,const char* url_file);
int   __cdecl httrackengine_chopt(httrackp *opt);
int   __cdecl httrackengine_loop(httrackp *opt, lien_back* back,int back_max,int back_index,int lien_n,int lien_tot,int stat_time,hts_stat_struct* stats);
const char* __cdecl httrackengine_query(httrackp *opt, const char* question);
const char* __cdecl httrackengine_query2(httrackp *opt, const char* question);
const char* __cdecl httrackengine_query3(httrackp *opt, const char* question);
void  __cdecl httrackengine_pause(httrackp *opt, const char* lockfile);
void  __cdecl httrackengine_filesave(httrackp *opt, const char* file);
void  __cdecl httrackengine_filesave2(httrackp *opt, const char* adr, const char* fil, const char* save, int is_new, int is_modified, int not_updated);

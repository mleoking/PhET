...
public class MembraneChannelsCanvas extends PhetPCanvas {
    ...
    public MembraneChannelsCanvas( MembraneChannelsModel model ) {
        ...
        mvt = ModelViewTransform.createSinglePointScaleInvertedYMapping( new Point2D.Double( 0, 0 ),
                                                                         new Point( (int) Math.round( MembraneChannelsDefaults.INTERMEDIATE_RENDERING_SIZE.width * 0.55 ), // Mult by 0.5 is center.
                                                                                    (int) Math.round( MembraneChannelsDefaults.INTERMEDIATE_RENDERING_SIZE.height * 0.35 ) ), 8 );
        ...
        Rectangle2D transformedParticleChamberRect =
                mvt.modelToView( MembraneChannelsModel.getOverallParticleChamberRect() ).getBounds2D();
        ...
        Rectangle2D transformedMembraneRect = mvt.modelToView( membraneRect ).getBounds2D();

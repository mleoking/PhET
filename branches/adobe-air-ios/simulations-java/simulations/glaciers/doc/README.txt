...
glaciers-design.odt : first design doc (editable, in Open Office format)
glaciers-design-part2.pdf : second design doc, probably out of date (don't know where the editable version of this is)
glaciers-estimate-2008-03-07.pdf : development work estimate for some features
glaciers-interface-mockup.svg : graphics used to mock up screen shots, created using Inkscape
glaciers-discussion.doc : misc discussion notes, not sure how relevant or accurate these are

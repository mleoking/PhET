...
public final class NVVertexAttribInteger64bit {
	...
	public static void glVertexAttribL1NV(int index, LongBuffer v) {
		...
		nglVertexAttribL1i64vNV(index, v, v.position(), function_pointer);
	}
	static native void nglVertexAttribL1i64vNV(int index, LongBuffer v, int v_position, long function_pointer);
	...
	public static void glVertexAttribL2NV(int index, LongBuffer v) {
		...
		nglVertexAttribL2i64vNV(index, v, v.position(), function_pointer);
	}
	static native void nglVertexAttribL2i64vNV(int index, LongBuffer v, int v_position, long function_pointer);
	...
	public static void glVertexAttribL3NV(int index, LongBuffer v) {
		...
		nglVertexAttribL3i64vNV(index, v, v.position(), function_pointer);
	}
	static native void nglVertexAttribL3i64vNV(int index, LongBuffer v, int v_position, long function_pointer);
	...
	public static void glVertexAttribL4NV(int index, LongBuffer v) {
		...
		nglVertexAttribL4i64vNV(index, v, v.position(), function_pointer);
	}
	static native void nglVertexAttribL4i64vNV(int index, LongBuffer v, int v_position, long function_pointer);
	...
	public static void glVertexAttribL1uNV(int index, LongBuffer v) {
		...
		BufferChecks.checkFunctionAddress(function_pointer);
		BufferChecks.checkBuffer(v, 1);
		nglVertexAttribL1ui64vNV(index, v, v.position(), function_pointer);
	}
	static native void nglVertexAttribL1ui64vNV(int index, LongBuffer v, int v_position, long function_pointer);
	...
	public static void glVertexAttribL2uNV(int index, LongBuffer v) {
		...
		BufferChecks.checkFunctionAddress(function_pointer);
		BufferChecks.checkBuffer(v, 2);
		nglVertexAttribL2ui64vNV(index, v, v.position(), function_pointer);
	}
	static native void nglVertexAttribL2ui64vNV(int index, LongBuffer v, int v_position, long function_pointer);
	...
	public static void glVertexAttribL3uNV(int index, LongBuffer v) {
		...
		BufferChecks.checkFunctionAddress(function_pointer);
		BufferChecks.checkBuffer(v, 3);
		nglVertexAttribL3ui64vNV(index, v, v.position(), function_pointer);
	}
	static native void nglVertexAttribL3ui64vNV(int index, LongBuffer v, int v_position, long function_pointer);
	...
	public static void glVertexAttribL4uNV(int index, LongBuffer v) {
		...
		BufferChecks.checkFunctionAddress(function_pointer);
		BufferChecks.checkBuffer(v, 4);
		nglVertexAttribL4ui64vNV(index, v, v.position(), function_pointer);
	}
	static native void nglVertexAttribL4ui64vNV(int index, LongBuffer v, int v_position, long function_pointer);
	...
	public static void glGetVertexAttribLNV(int index, int pname, LongBuffer params) {
		...
		nglGetVertexAttribLi64vNV(index, pname, params, params.position(), function_pointer);
	}
	static native void nglGetVertexAttribLi64vNV(int index, int pname, LongBuffer params, int params_position, long function_pointer);
	...
	public static void glGetVertexAttribLuNV(int index, int pname, LongBuffer params) {
		...
		BufferChecks.checkFunctionAddress(function_pointer);
		BufferChecks.checkBuffer(params, 4);
		nglGetVertexAttribLui64vNV(index, pname, params, params.position(), function_pointer);
	}
	static native void nglGetVertexAttribLui64vNV(int index, int pname, LongBuffer params, int params_position, long function_pointer);

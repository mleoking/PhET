...
public final class ARBDrawInstanced {
	...
	static native void nglDrawElementsInstancedARB(int mode, int indices_count, int type, Buffer indices, int indices_position, int primcount, long function_pointer);

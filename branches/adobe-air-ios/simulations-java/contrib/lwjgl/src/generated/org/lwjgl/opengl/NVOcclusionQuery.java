...
public final class NVOcclusionQuery {
	...
	static native void nglGenOcclusionQueriesNV(int piIDs_n, IntBuffer piIDs, int piIDs_position, long function_pointer);
	...
	public static int glGenOcclusionQueriesNV() {
		...
		long function_pointer = caps.glGenOcclusionQueriesNV;
		BufferChecks.checkFunctionAddress(function_pointer);
		IntBuffer piIDs = APIUtil.getBufferInt();
		nglGenOcclusionQueriesNV(1, piIDs, piIDs.position(), function_pointer);
		return piIDs.get(0);
	}
	...
	static native void nglDeleteOcclusionQueriesNV(int piIDs_n, IntBuffer piIDs, int piIDs_position, long function_pointer);
	...
	public static void glDeleteOcclusionQueriesNV(int piID) {
		...
		long function_pointer = caps.glDeleteOcclusionQueriesNV;
		BufferChecks.checkFunctionAddress(function_pointer);
		nglDeleteOcclusionQueriesNV(1, APIUtil.getBufferInt().put(0, piID), 0, function_pointer);
	}
	...
	static native void nglGetOcclusionQueryuivNV(int id, int pname, IntBuffer params, int params_position, long function_pointer);
	...
	static native void nglGetOcclusionQueryivNV(int id, int pname, IntBuffer params, int params_position, long function_pointer);

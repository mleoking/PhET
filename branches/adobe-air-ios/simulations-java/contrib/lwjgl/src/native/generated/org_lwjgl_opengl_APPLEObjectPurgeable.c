...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_APPLEObjectPurgeable_nglGetObjectParameterivAPPLE(JNIEnv *env, jclass clazz, jint objectType, jint name, jint pname, jobject params, jint params_position, jlong function_pointer) {

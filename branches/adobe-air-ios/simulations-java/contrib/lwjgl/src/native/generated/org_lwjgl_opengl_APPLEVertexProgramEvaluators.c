...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_APPLEVertexProgramEvaluators_nglMapVertexAttrib1dAPPLE(JNIEnv *env, jclass clazz, jint index, jint size, jdouble u1, jdouble u2, jint stride, jint order, jobject points, jint points_position, jlong function_pointer) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_APPLEVertexProgramEvaluators_nglMapVertexAttrib1fAPPLE(JNIEnv *env, jclass clazz, jint index, jint size, jfloat u1, jfloat u2, jint stride, jint order, jobject points, jint points_position, jlong function_pointer) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_APPLEVertexProgramEvaluators_nglMapVertexAttrib2dAPPLE(JNIEnv *env, jclass clazz, jint index, jint size, jdouble u1, jdouble u2, jint ustride, jint uorder, jdouble v1, jdouble v2, jint vstride, jint vorder, jobject points, jint points_position, jlong function_pointer) {
	const GLdouble *points_address = ((const GLdouble *)(*env)->GetDirectBufferAddress(env, points)) + points_position;
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_APPLEVertexProgramEvaluators_nglMapVertexAttrib2fAPPLE(JNIEnv *env, jclass clazz, jint index, jint size, jfloat u1, jfloat u2, jint ustride, jint uorder, jfloat v1, jfloat v2, jint vstride, jint vorder, jobject points, jint points_position, jlong function_pointer) {
	const GLfloat *points_address = ((const GLfloat *)(*env)->GetDirectBufferAddress(env, points)) + points_position;

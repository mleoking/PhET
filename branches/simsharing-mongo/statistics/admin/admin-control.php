...
<html>
	<head>
		<title>PhET Statistics - Administration</title>
		...
		<script language="javascript" src="admin-control.js">
		</script>
		<script type="text/javascript" src="../report/calendarDateInput.js">
		/***********************************************
		...
		***********************************************/
		...
		<link rel="stylesheet" type="text/css" href="../report/general-query.css" />
	</head>
	<body>
		<div id="content">

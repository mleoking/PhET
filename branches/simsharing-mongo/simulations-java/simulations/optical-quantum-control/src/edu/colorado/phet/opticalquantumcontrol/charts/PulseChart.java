...
/**
 * PulseChart is the chart used by the input and output pulse views.
 *
 * @author Chris Malley (cmalley@pixelzoom.com)
 * @version $Revision$
 */
public class PulseChart extends Chart {
     ...
     * @param chartSize
     */
    public PulseChart( Component component, Range2D range, Dimension chartSize ) {

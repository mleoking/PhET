...
/**
 * ColorVisionResources is a wrapper around the PhET resource loader.
 * If we decide to use a different technique to load resources in the 
 * future, all changes will be encapsulated here.
 *
 * @author Chris Malley (cmalley@pixelzoom.com)
 */
public class ColorVisionResources {
    
    private static final PhetResources RESOURCES = new PhetResources( ColorVisionConstants.PROJECT_NAME );
    
    /* not intended for instantiation */
    private ColorVisionResources() {}

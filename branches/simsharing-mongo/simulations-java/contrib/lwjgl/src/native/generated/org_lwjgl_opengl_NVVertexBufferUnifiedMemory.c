...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_NVVertexBufferUnifiedMemory_nglGetIntegerui64i_vNV(JNIEnv *env, jclass clazz, jint value, jint index, jobject result, jint result_position, jlong function_pointer) {

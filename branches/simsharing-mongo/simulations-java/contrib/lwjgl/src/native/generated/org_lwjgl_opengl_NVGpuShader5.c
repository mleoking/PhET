...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_NVGpuShader5_nglUniform1i64vNV(JNIEnv *env, jclass clazz, jint location, jint count, jobject value, jint value_position, jlong function_pointer) {
	const GLint64EXT *value_address = ((const GLint64EXT *)(*env)->GetDirectBufferAddress(env, value)) + value_position;
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_NVGpuShader5_nglUniform2i64vNV(JNIEnv *env, jclass clazz, jint location, jint count, jobject value, jint value_position, jlong function_pointer) {
	const GLint64EXT *value_address = ((const GLint64EXT *)(*env)->GetDirectBufferAddress(env, value)) + value_position;
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_NVGpuShader5_nglUniform3i64vNV(JNIEnv *env, jclass clazz, jint location, jint count, jobject value, jint value_position, jlong function_pointer) {
	const GLint64EXT *value_address = ((const GLint64EXT *)(*env)->GetDirectBufferAddress(env, value)) + value_position;
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_NVGpuShader5_nglUniform4i64vNV(JNIEnv *env, jclass clazz, jint location, jint count, jobject value, jint value_position, jlong function_pointer) {
	const GLint64EXT *value_address = ((const GLint64EXT *)(*env)->GetDirectBufferAddress(env, value)) + value_position;
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_NVGpuShader5_nglUniform1ui64vNV(JNIEnv *env, jclass clazz, jint location, jint count, jobject value, jint value_position, jlong function_pointer) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_NVGpuShader5_nglUniform2ui64vNV(JNIEnv *env, jclass clazz, jint location, jint count, jobject value, jint value_position, jlong function_pointer) {
	const GLuint64EXT *value_address = ((const GLuint64EXT *)(*env)->GetDirectBufferAddress(env, value)) + value_position;
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_NVGpuShader5_nglUniform3ui64vNV(JNIEnv *env, jclass clazz, jint location, jint count, jobject value, jint value_position, jlong function_pointer) {
	const GLuint64EXT *value_address = ((const GLuint64EXT *)(*env)->GetDirectBufferAddress(env, value)) + value_position;
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_NVGpuShader5_nglUniform4ui64vNV(JNIEnv *env, jclass clazz, jint location, jint count, jobject value, jint value_position, jlong function_pointer) {
	const GLuint64EXT *value_address = ((const GLuint64EXT *)(*env)->GetDirectBufferAddress(env, value)) + value_position;
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_NVGpuShader5_nglGetUniformi64vNV(JNIEnv *env, jclass clazz, jint program, jint location, jobject params, jint params_position, jlong function_pointer) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_NVGpuShader5_nglGetUniformui64vNV(JNIEnv *env, jclass clazz, jint program, jint location, jobject params, jint params_position, jlong function_pointer) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_NVGpuShader5_nglProgramUniform1i64vNV(JNIEnv *env, jclass clazz, jint program, jint location, jint count, jobject value, jint value_position, jlong function_pointer) {
	const GLint64EXT *value_address = ((const GLint64EXT *)(*env)->GetDirectBufferAddress(env, value)) + value_position;
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_NVGpuShader5_nglProgramUniform2i64vNV(JNIEnv *env, jclass clazz, jint program, jint location, jint count, jobject value, jint value_position, jlong function_pointer) {
	const GLint64EXT *value_address = ((const GLint64EXT *)(*env)->GetDirectBufferAddress(env, value)) + value_position;
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_NVGpuShader5_nglProgramUniform3i64vNV(JNIEnv *env, jclass clazz, jint program, jint location, jint count, jobject value, jint value_position, jlong function_pointer) {
	const GLint64EXT *value_address = ((const GLint64EXT *)(*env)->GetDirectBufferAddress(env, value)) + value_position;
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_NVGpuShader5_nglProgramUniform4i64vNV(JNIEnv *env, jclass clazz, jint program, jint location, jint count, jobject value, jint value_position, jlong function_pointer) {
	const GLint64EXT *value_address = ((const GLint64EXT *)(*env)->GetDirectBufferAddress(env, value)) + value_position;
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_NVGpuShader5_nglProgramUniform1ui64vNV(JNIEnv *env, jclass clazz, jint program, jint location, jint count, jobject value, jint value_position, jlong function_pointer) {
	const GLuint64EXT *value_address = ((const GLuint64EXT *)(*env)->GetDirectBufferAddress(env, value)) + value_position;
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_NVGpuShader5_nglProgramUniform2ui64vNV(JNIEnv *env, jclass clazz, jint program, jint location, jint count, jobject value, jint value_position, jlong function_pointer) {
	const GLuint64EXT *value_address = ((const GLuint64EXT *)(*env)->GetDirectBufferAddress(env, value)) + value_position;
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_NVGpuShader5_nglProgramUniform3ui64vNV(JNIEnv *env, jclass clazz, jint program, jint location, jint count, jobject value, jint value_position, jlong function_pointer) {
	const GLuint64EXT *value_address = ((const GLuint64EXT *)(*env)->GetDirectBufferAddress(env, value)) + value_position;
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_NVGpuShader5_nglProgramUniform4ui64vNV(JNIEnv *env, jclass clazz, jint program, jint location, jint count, jobject value, jint value_position, jlong function_pointer) {
	const GLuint64EXT *value_address = ((const GLuint64EXT *)(*env)->GetDirectBufferAddress(env, value)) + value_position;

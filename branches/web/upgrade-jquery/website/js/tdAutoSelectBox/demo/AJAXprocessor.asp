...
'This is sample ASP (VBScript) logical that proccesses an AJAX request and returns 
'a simple response to be processed in the Javascript of the calling page.

returnMsg = ProcessXMLRequest()

if not isNull(returnMsg) then
    Response.Clear

    ' Response.ContentType = "text/xml" 'content type must be XML!
    ' Response.Write "<?xml version='1.0' ?>" 
    Response.Write returnMsg
else
    Response.Write "" //return nothing
end if
...
Function ProcessXMLRequest()
    ...
    StateCd = Request("stateCode")
    CityCd = Request("cityCode")
    ...
    if not StateCd="" then
        ...
        elseif CityCd = "FNL" then
            AJAXResponse = "80521|80522|80523|80524|80525|80526|80527|80528|80553"
        elseif CityCd = "GJT" then
            AJAXResponse = "81501|81502|81503|81504|81505|81506"
        elseif CityCd = "TAD" then
            AJAXResponse = "81082"
        else
            AJAXResponse = "nothing;0"
        end if
    end if
    ProcessXMLRequest = AJAXResponse //return the Message

End Function 'ProcessXMLRequest

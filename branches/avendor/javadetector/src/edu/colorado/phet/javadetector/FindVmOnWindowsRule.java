...
public class FindVmOnWindowsRule extends CustomCodeRule {
    ...
    public boolean evaluateRule() {
        ...
        InstallerResources ir = (InstallerResources)ruleProxy.getService( InstallerResources.class );

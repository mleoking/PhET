...
import edu.colorado.phet.motionseries.model.SurfaceSegment
...
class RampSegmentNode(rampSegment: SurfaceSegment, mytransform: ModelViewTransform2D, rampSurfaceModel: RampSurfaceModel) extends PNode with HasPaint {
...
class RotatableSegmentNode(rampSegment: SurfaceSegment, mytransform: ModelViewTransform2D, rampSurfaceModel: RampSurfaceModel) extends RampSegmentNode(rampSegment, mytransform, rampSurfaceModel) {
...
//class ReverseRotatableSegmentNode(rampSegment: SurfaceSegment, mytransform: ModelViewTransform2D, rampSurfaceModel: RampSurfaceModel) extends RampSegmentNode(rampSegment, mytransform, rampSurfaceModel) {
//  line.addInputEventListener(new CursorHandler)

...
object TestFBD extends Application {
  ...
  canvas.addScreenChild(new FreeBodyDiagramNode(new FreeBodyDiagramModel(false), 200, 200, 20, 20, new CoordinateFrameModel(new SurfaceSegment(new Point2D.Double(0,0),new Point2D.Double(10,10))), new AdjustableCoordinateModel,

...
public class MeterStick extends FluidPressureAndFlowRuler {
    public MeterStick( ModelViewTransform transform, final Property<Boolean> visible, final Property<Boolean> setVisible, Point2D.Double rulerModelOrigin, ResetModel resetModel ) {
    ...
    public MeterStick( ModelViewTransform transform, final Property<Boolean> visible, final Property<Boolean> setVisible, Point2D.Double rulerModelOrigin, boolean flag, ResetModel resetModel ) {

...
public class SingleSourceListenModule extends Module {

    protected SingleSourceListenModule( ApplicationModel appModel ) {
        super( "<html>Listen to<br>Single Source</html>" );

        this.setModel( new SoundModel( appModel.getClock() ) );
        this.setApparatusPanel( new SingleSourceApparatusPanel( (SoundModel)getModel(), "Listen" ) );

 ...
 *         <p/>
 *         History:
 *         2-28-2013 modified for touchscreen mockups
 */
public class ThumbnailTabModulePane extends ThumbnailTabPane implements ITabbedModulePane {
    private Module current;
    private PhetApplication application;

    public ThumbnailTabModulePane() {
        this( true );
    }

    public ThumbnailTabModulePane( boolean logoVisible ) {

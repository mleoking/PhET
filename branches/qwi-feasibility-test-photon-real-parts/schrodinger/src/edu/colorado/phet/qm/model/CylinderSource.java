...
//    public void initializeEntrantWave( DiscreteModel discreteModel ) {
//        for( int i = region.x; i < region.x + region.width; i++ ) {
//            for( int k = region.y; k < region.y + region.height; k++ ) {
//                if( ellipse.contains( i, k ) && discreteModel.getWavefunction().containsLocation( i, k ) ) {
//                    Complex value = wave.getValue( i, k, discreteModel.getSimulationTime() );
////                    waveModel.setValue( i,k,value.real, value.imag );
//                    discreteModel.setBoundaryCondition( i, k, value );
//                }
//            }
//        }
//    }

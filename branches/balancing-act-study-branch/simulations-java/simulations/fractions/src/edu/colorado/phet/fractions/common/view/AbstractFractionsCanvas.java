...
public class AbstractFractionsCanvas extends PhetPCanvas {
    ...
    //The dimension was determined by running on Windows and inspecting the dimension of the canvas after menu bar and tabs are added
    ...
    protected AbstractFractionsCanvas() {

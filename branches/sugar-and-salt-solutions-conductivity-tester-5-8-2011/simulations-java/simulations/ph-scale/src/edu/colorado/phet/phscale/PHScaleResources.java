...
/**
 * PHScaleResources is a wrapper around the PhET resource loader.
...
public class PHScaleResources {
    ...
    private static final PhetResources RESOURCES = new PhetResources( PHScaleConstants.PROJECT_NAME );
    
    /* not intended for instantiation */
    private PHScaleResources() {}

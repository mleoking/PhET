    ...
    function render_content() {
        ...
        print <<<EOT
            ...
            <ol>
                ...
                <li>
                    Press the "Submit to PhET" button when you've finished your translations. This saves your translation to a file, which you can email to PhET. Note the file name and email address shown in the dialog.
                </li>
            ...
            To translate Java common strings, download <a href="get-java-common-strings.php">java-common-strings_en.jar</a>.

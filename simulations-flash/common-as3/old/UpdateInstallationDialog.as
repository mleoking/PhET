...
class edu.colorado.phet.flashcommon.old.UpdateInstallationDialog extends edu.colorado.phet.flashcommon.old.CommonDialog {
	...
	public function UpdateInstallationDialog( installerTimestamp : Number, installerAskLaterDays : Number ) {
        super( "updateInstallation", _level0.SimStrings.get( "NewVersionAvailable", "New Version Available" ) );
		...
		str += SimStrings.get("InstallationDated", "Your PhET Offline Website Installation is dated {0}.", [FlashCommon.dateString(FlashCommon.dateOfSeconds(common.getInstallerCreationTimestamp()))]) + "\n";
		str += SimStrings.get("InstallationNewer", "A newer version is available, dated {0}.", [FlashCommon.dateString(FlashCommon.dateOfSeconds(newInstallerTimestamp))]) + "\n";
		str += "\n";
		str += SimStrings.get("InstallerAsk", "Would you like to get the latest PhET Offline Website Installer?");
		...
		yesButton = new JButton(SimStrings.get("Yes!", "Yes!"));
		...
		tellMoreButton = new JButton(SimStrings.get("TellMore", "Tell me more..."));

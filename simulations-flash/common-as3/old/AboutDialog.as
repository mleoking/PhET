...
class edu.colorado.phet.flashcommon.old.AboutDialog extends CommonDialog {
    ...
    public function AboutDialog() {
        super( "about", _level0.SimStrings.get( "AboutSim", "About {0}", [ _level0.common.getSimTitle() ] ) );
		...
		str += SimStrings.get("Version", "Version") + ": " + common.getFullVersionString() + "\n";
		str += SimStrings.get("BuildDate", "Build Date") + ": " + FlashCommon.dateString(FlashCommon.dateOfSeconds(common.getVersionTimestamp())) + "\n";
		if(common.getDistributionTag() != null || common.getSimName() == "flash-common-strings") {
			str += SimStrings.get("Distribution", "Distribution") + ": " + String(common.getDistributionTag()) + "\n";
		}
		str += "\n";
		str += SimStrings.get("FlashVersion", "Flash Version") + ": " + System.capabilities.version + "\n";
		str += SimStrings.get("OSVersion", "OS Version") + ": " + System.capabilities.os + "\n";
		...
		var str : String = SimStrings.get("SoftwareAgreement", "Software Agreement");
		...
		str = SimStrings.get("Credits", "Credits");
		// temporary fix for improper rendering of Arabic strings
		if( common.getLocale() == "ar" ) {
			str = "..." + str;
		} else {

...
class edu.colorado.phet.flashcommon.old.StatisticsDetailsDialog extends edu.colorado.phet.flashcommon.old.CommonDialog {
	...
	public function StatisticsDetailsDialog() {
        super( "statisticsDetails", _level0.SimStrings.get( "PrivacyDetails", "Privacy Details" ) )
		...
		var str : String = "";
		str += SimStrings.get("SentInformation", "The information shown below will be sent to PhET when the simulation starts.") + "\n\n";
		str += "<font size=\"12\">"

...
class edu.colorado.phet.flashcommon.old.CommonButtons {
	...
	public function CommonButtons(position : String) {
		...
		var aboutButton : JButton = new JButton(SimStrings.get("About...", "About..."));
		...
		if(!common.fromPhetWebsite()) {
			...
			var preferencesButton : JButton = new JButton(SimStrings.get("Preferences", "Preferences..."));

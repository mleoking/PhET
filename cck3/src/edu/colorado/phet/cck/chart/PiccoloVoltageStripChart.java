...
public class PiccoloVoltageStripChart extends DoubleTerminalFloatingChart.Piccolo {

    public PiccoloVoltageStripChart( PhetPCanvas pSwingCanvas, String title, IClock clock, Circuit circuit ) {
        super( pSwingCanvas, title, new TwoTerminalValueReader() {
            public double getValue( Shape a, Shape b ) {
                return 0;
            }
        }, clock );
        super.setValueReader( new PiccoloVoltageStripChart.VoltageReader( circuit ) );

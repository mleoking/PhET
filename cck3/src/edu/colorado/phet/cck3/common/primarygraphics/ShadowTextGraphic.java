 ...
 */
public class ShadowTextGraphic extends PhetGraphic implements IPhetTextGraphic {
    private PhetTextGraphic foreground;
    private PhetTextGraphic background;
    private int dx;
    private int dy;

    public ShadowTextGraphic( Component component, String text, Font font, int x, int y, Color foregroundColor, int dx, int dy, Color backgroundColor ) {
        super( component );
        this.dx = dx;
        this.dy = dy;

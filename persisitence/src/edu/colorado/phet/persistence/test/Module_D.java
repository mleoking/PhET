...
//            panel = new ApparatusPanel();
        ...
        PhetGraphic pg2 = new PhetShapeGraphic( panel, new Rectangle( 50, 50, 50, 50 ), Color.green, new BasicStroke( 1 ), Color.black );
...
//        panel.addGraphic( g );
    ...
    void addGraphicToPanel( final PhetGraphic pg, ApparatusPanel panel ) {
        pg.setCursorHand();
        pg.setBoundsDirty();
        pg.setLocation( 0, 0 );

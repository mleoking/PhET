<?php
	...
	define("PHET_RIPPER_FILTER",        		'"+*phet.colorado.edu/new*" "+*phet.colorado.edu/Design*" "+*phet.colorado.edu/physics*" "+*phet.colorado.edu/sims*" "-*get-upload.php?contribution_file_id=*" "-*view-contribution.php*" "-*download-archive.php*" "-*/phet-dist/*" "-*search.php*" "-*get-run-offline.php*" "-*login-and-redirect.php*" 
	"-*do-ajax-login.php*" "-*get-member-file.php*" "-*/teacher_ideas/browse.php?*" ');
	...
	define("AUTORUN_ICON_NAME", 				'Phet-logo-48x48.ico');
	...
	define("RIPPER_ARGS", '"'.PHET_WEBSITE_URL.'" -O "'.RIPPED_WEBSITE_ROOT.'" '.PHET_RIPPER_FILTER.' -j %q0');

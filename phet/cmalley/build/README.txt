This folder contains files that are specific to my IDE, platform or absolute path.

Eclipse files include JAR description (*.jardec) files and JAR Manifest files (*.mf).

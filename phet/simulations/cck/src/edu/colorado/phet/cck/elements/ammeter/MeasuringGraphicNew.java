...
public class MeasuringGraphicNew {
    ...
    public static class MeasureGraphic implements Graphic {
        ArrayList data = new ArrayList();
        Point location;
        MeasuringGraphicNew mgn = new MeasuringGraphicNew();

        public MeasureGraphic( Point location ) {
        ...
        public void paint( Graphics2D g ) {
            mgn.doPaint( g, location, data );
        }
    }

    void doPaint( Graphics2D g, Point loc, java.util.List data ) {
        paint( g, loc, data );
    }

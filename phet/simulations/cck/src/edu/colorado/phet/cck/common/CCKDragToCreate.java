 ...
 */
public class CCKDragToCreate implements InteractiveGraphic {
    ...
    public CCKDragToCreate( InteractiveGraphic target, InteractiveGraphicSource source, String tipText, Point tipLocation, Proxy ps ) {
        this.icon = target;
        this.source = source;
        this.proxy = ps;

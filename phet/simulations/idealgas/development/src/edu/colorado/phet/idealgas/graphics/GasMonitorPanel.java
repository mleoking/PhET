...
public class GasMonitorPanel extends MonitorPanel {
    ...
    private edu.colorado.phet.idealgas.graphics.PressureGaugePanel pressureGauge;
...
//    private OrderOfMagnitudeSpinner pressureSpinner;
     ...
     * Constructor
     */
    public GasMonitorPanel( Class[] speciesClasses ) {
    ...
    private void init() {
        ...
        pressureGauge = new edu.colorado.phet.idealgas.graphics.PressureGaugePanel();

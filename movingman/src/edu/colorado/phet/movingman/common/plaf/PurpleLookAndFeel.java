...
public class PurpleLookAndFeel extends MetalLookAndFeel {
    ...
    protected void initComponentDefaults(UIDefaults table) {
        ...
        selImage = RescaleOp3.rescaleXMaintainAspectRatio(selImage, checkBoxIconImageWidth);
        unImage = RescaleOp3.rescaleXMaintainAspectRatio(unImage, checkBoxIconImageWidth);

 ...
 * @version $Revision$
 */
public class PhotoelectricSlider extends GraphicSlider {
     ...
     */
    public PhotoelectricSlider( Component component, int trackLength ) {
    ...
    public PhotoelectricSlider( Component component, int trackLength, int trackWidth, Color trackColor ) {
        ...
        // Knob
        PhetGraphic knob = new PhetImageGraphic( component, PhotoelectricConfig.SLIDER_KNOB_IMAGE );
        knob.centerRegistrationPoint();
        setKnob( knob );

        // Knob Highlight
        PhetGraphic knobHighlight = new PhetImageGraphic( component, PhotoelectricConfig.SLIDER_KNOB_HIGHLIGHT_IMAGE );

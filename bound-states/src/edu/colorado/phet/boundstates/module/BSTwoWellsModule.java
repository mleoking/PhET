...
public class BSTwoWellsModule extends BSAbstractModule {
    ...
    private static final BSWellType[] WELL_TYPES = { BSWellType.COULOMB, BSWellType.SQUARE };
    ...
    private static final BSDoubleRange WIDTH_RANGE = new BSDoubleRange( 0.1, 3, 1 ); // nm
    private static final BSDoubleRange SPACING_RANGE = new BSDoubleRange( 0.3, 3, 1 ); // nm
    private static final BSDoubleRange SEPARATION_RANGE = new BSDoubleRange( 0.1, 2, 1 ); // nm

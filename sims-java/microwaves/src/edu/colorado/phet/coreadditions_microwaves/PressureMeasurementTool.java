...
public class PressureMeasurementTool extends MouseInputAdapter {
    ...
    private edu.colorado.phet.common_microwaves.view.ApparatusPanel panel;
    private double y;
    ...
    public PressureMeasurementTool( edu.colorado.phet.common_microwaves.view.ApparatusPanel panel ) {

...
public class FlexSimulationProject extends PhetProject {
    ...
    public boolean build() throws Exception {
        ...
        Process p = Runtime.getRuntime().exec( new String[]{getMxmlcExecutable(), "-output", "deploy/" + getName() + ".swf", "-compiler.source-path", "src", "../../contrib/away3d/fp9", "../../common/src", "../../../simulations-flash/contrib/box2d/src","-compiler.accessible", "-compiler.optimize", "-target-player", "9", getMXML()}, null, getProjectDir() );

...
import edu.colorado.phet.idealgas.model.ScalarDataRecorder;
...
public class Balloon extends HollowSphere {
    ...
    private Vector2D momentumPre = new Vector2D.Float();
    private Vector2D momentumPost = new Vector2D.Float();
     ...
     */
    IdealGasParticle idealGasParticle = new IdealGasParticle( new Vector2D.Float(),
                                              new Vector2D.Float(),
                                              new Vector2D.Float(),
                                              0 );
...
//        momentumPost = momentumPost.multiply( this.getMass() );
        ...
        float impact = (float)momentumChange.getMagnitude();

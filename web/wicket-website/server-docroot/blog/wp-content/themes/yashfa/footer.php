...
<div id="extra-footer">
    ...
    <div id="footer">
        ...
        <p class="right"><a href="http://wpgpl.com/themes/yashfa" title="Free WordPress Theme: Yashfa">Yashfa</a> ver.
            1.7 <?php _e( 'created by', 'yashfa' )?> <a href="http://wpgpl.com" title="WordPress GPL Themes & Plugins">WP
                GPL</a></p>
    </div>
</div>

-injars /Volumes/files/phet-workspace/jars/glaciers.jar
...
-outjars /Volumes/files/phet-workspace/jars/glaciers-proguard.jar
...
-keepclasseswithmembers public class edu.colorado.phet.glaciers.GlaciersApplication {

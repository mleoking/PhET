...
(function( a, b ) {
    ...
    function f( a, c, f ) {
        if ( f === b && a.nodeType === 1 ) {
            ...
            if ( typeof f === "string" ) {
                try {f = f === "true" ? !0 : f === "false" ? !1 : f === "null" ? null : d.isNaN( f ) ? e.test( f ) ? d.parseJSON( f ) : f : parseFloat( f )}
                catch( g ) {}
                d.data( a, c, f )
            }
            else {
        ...
        if ( e && e.length && f ) {
            ...
            d.support.scriptEval = function() {
                if ( j === null ) {
                    ...
                    try {e.appendChild( c.createTextNode( "window." + f + "=1;" ) )}
                    catch( g ) {}
            ...
            try {delete b.test}
            catch( k ) {d.support.deleteExpando = !1}
    ...
    d.event = {add:function( c, e, f, g ) {
        if ( c.nodeType !== 3 && c.nodeType !== 8 ) {
            try {d.isWindow( c ) && (c !== a && !c.frameElement) && (c = a)}
            catch( h ) {}
            if ( f === !1 ) {
                f = v;
            } else if ( !f ) {
        ...
        try {e && e.nodeName && d.noData[e.nodeName.toLowerCase()] || e["on" + f] && e["on" + f].apply( e, c ) === !1 && (a.result = !1, a.preventDefault())}
        catch( j ) {}
        if ( !a.isPropagationStopped() && i ) {
            ...
            if ( (!o._default || o._default.call( e, a ) === !1) && !n && !(l && l.nodeName && d.noData[l.nodeName.toLowerCase()]) ) {
                try {l[m] && (k = l["on" + m], k && (l["on" + m] = null), d.event.triggered = !0, l[m]())}
                catch( q ) {}
    ...
    try {bJ = c.location.href}
    catch( bL ) {bJ = c.createElement( "a" ), bJ.href = "", bJ = bJ.href}

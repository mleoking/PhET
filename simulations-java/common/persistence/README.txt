...
Modules
-------
Each module with state that must be preserved needs to have an associated subclass of ModuleStateDescriptor,
with Java Beans conformant code that looks something like the following example. Because MyModuleStateDescriptor
in this example is an inner class, it must be public and static in order to be Java Beans conformant.

public class MyModule extends Module {
    private int lastX;

    //////////////////////////////////////////////////////////
    // Lots of normal Module code
    ...
    /**
     * Returns a state descriptor for this module.
     */
    ...
    /**
     * Subclass of ModuleStateDescriptor that captures the state of MyModule.
     */

...
public final class GL41 {
	...
	public static int glCreateShaderProgram(int type, int count, ByteBuffer strings) {
		...
		int __result = nglCreateShaderProgramv(type, count, MemoryUtil.getAddress(strings), function_pointer);
		return __result;
	}
	static native int nglCreateShaderProgramv(int type, int count, long strings, long function_pointer);
	...
	public static int glCreateShaderProgram(int type, CharSequence[] strings) {
		...
		int __result = nglCreateShaderProgramv(type, strings.length, APIUtil.getBufferNT(caps, strings), function_pointer);
		return __result;
	}

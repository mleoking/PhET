...
public final class NVPathRendering {
	...
	public static void glStencilFillPathInstancedNV(int pathNameType, ByteBuffer paths, int fillMode, int mask, int transformType, FloatBuffer transformValues) {
		...
		if (transformValues != null)
			BufferChecks.checkBuffer(transformValues, GLChecks.calculateTransformPathValues(transformType));
		nglStencilFillPathInstancedNV(paths.remaining() / GLChecks.calculateBytesPerPathName(pathNameType), pathNameType, MemoryUtil.getAddress(paths), 0, fillMode, mask, transformType, MemoryUtil.getAddressSafe(transformValues), function_pointer);
	}
	...
	public static void glStencilStrokePathInstancedNV(int pathNameType, ByteBuffer paths, int reference, int mask, int transformType, FloatBuffer transformValues) {
		...
		if (transformValues != null)
			BufferChecks.checkBuffer(transformValues, GLChecks.calculateTransformPathValues(transformType));
		nglStencilStrokePathInstancedNV(paths.remaining() / GLChecks.calculateBytesPerPathName(pathNameType), pathNameType, MemoryUtil.getAddress(paths), 0, reference, mask, transformType, MemoryUtil.getAddressSafe(transformValues), function_pointer);
	}
	...
	public static void glCoverFillPathInstancedNV(int pathNameType, ByteBuffer paths, int coverMode, int transformType, FloatBuffer transformValues) {
		...
		if (transformValues != null)
			BufferChecks.checkBuffer(transformValues, GLChecks.calculateTransformPathValues(transformType));
		nglCoverFillPathInstancedNV(paths.remaining() / GLChecks.calculateBytesPerPathName(pathNameType), pathNameType, MemoryUtil.getAddress(paths), 0, coverMode, transformType, MemoryUtil.getAddressSafe(transformValues), function_pointer);
	}
	...
	public static void glCoverStrokePathInstancedNV(int pathNameType, ByteBuffer paths, int coverMode, int transformType, FloatBuffer transformValues) {
		...
		if (transformValues != null)
			BufferChecks.checkBuffer(transformValues, GLChecks.calculateTransformPathValues(transformType));
		nglCoverStrokePathInstancedNV(paths.remaining() / GLChecks.calculateBytesPerPathName(pathNameType), pathNameType, MemoryUtil.getAddress(paths), 0, coverMode, transformType, MemoryUtil.getAddressSafe(transformValues), function_pointer);
	}
	...
	public static void glGetPathMetricsNV(int metricQueryMask, int pathNameType, ByteBuffer paths, int stride, FloatBuffer metrics) {
		...
		nglGetPathMetricsNV(metricQueryMask, paths.remaining() / GLChecks.calculateBytesPerPathName(pathNameType), pathNameType, MemoryUtil.getAddress(paths), 0, stride, MemoryUtil.getAddress(metrics), function_pointer);
	}
	...
	public static void glGetPathSpacingNV(int pathListMode, int pathNameType, ByteBuffer paths, float advanceScale, float kerningScale, int transformType, FloatBuffer returnedSpacing) {
		...
		nglGetPathSpacingNV(pathListMode, numPaths, pathNameType, MemoryUtil.getAddress(paths), 0, advanceScale, kerningScale, transformType, MemoryUtil.getAddress(returnedSpacing), function_pointer);
	}

...
public final class EXTGpuProgramParameters {
	...
	static native void nglProgramEnvParameters4fvEXT(int target, int index, int count, FloatBuffer params, int params_position, long function_pointer);
	...
	static native void nglProgramLocalParameters4fvEXT(int target, int index, int count, FloatBuffer params, int params_position, long function_pointer);
}

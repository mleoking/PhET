...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_GL30_nglGetBooleani_v(JNIEnv *env, jclass clazz, jint value, jint index, jlong data, jlong function_pointer) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_GL30_nglGetIntegeri_v(JNIEnv *env, jclass clazz, jint value, jint index, jlong data, jlong function_pointer) {

...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_APPLEVertexArrayObject_nglDeleteVertexArraysAPPLE(JNIEnv *env, jclass clazz, jint n, jobject arrays, jint arrays_position, jlong function_pointer) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_APPLEVertexArrayObject_nglGenVertexArraysAPPLE(JNIEnv *env, jclass clazz, jint n, jobject arrays, jint arrays_position, jlong function_pointer) {

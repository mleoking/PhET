...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_APPLEFence_nglGenFencesAPPLE(JNIEnv *env, jclass clazz, jint n, jobject fences, jint fences_position, jlong function_pointer) {
	GLuint *fences_address = ((GLuint *)(*env)->GetDirectBufferAddress(env, fences)) + fences_position;
	glGenFencesAPPLEPROC glGenFencesAPPLE = (glGenFencesAPPLEPROC)((intptr_t)function_pointer);
	glGenFencesAPPLE(n, fences_address);
}

JNIEXPORT void JNICALL Java_org_lwjgl_opengl_APPLEFence_nglDeleteFencesAPPLE(JNIEnv *env, jclass clazz, jint n, jobject fences, jint fences_position, jlong function_pointer) {
	const GLuint *fences_address = ((const GLuint *)(*env)->GetDirectBufferAddress(env, fences)) + fences_position;

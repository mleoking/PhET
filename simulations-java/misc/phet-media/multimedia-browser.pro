-injars ant_output\jars\multimedia-browser.jar
-injars JIBS_1.6.5.jar
-injars simlauncher-module\lib\jdom.jar
-outjars ant_output\jars\multimedia-browser-pro.jar
...
-keepclasseswithmembers public class edu.colorado.phet.mm.MultimediaApplication {
    public static void main(java.lang.String[]);
}

-keep class org.jdom.adapters.DOMAdapter

...
public class PositionHistogramChartNode extends PhetPNode implements Observer {
    ...
    private void updateLayout() {
        ...
        final double maxHeight = Math.max( Math.max( Math.max( _measurementsLabel.getFullBounds().getHeight(), _titleLabel.getFullBounds().getHeight() ), 
                _startStopButtonWrapper.getFullBounds().getHeight() ), _clearButtonWrapper.getFullBounds().getHeight() ) + vertMargin;

    ...
    class FreeFall implements UpdateStrategy {
        ...
        private void interactWithTrack( SearchState searchState, SerializablePoint2D newLoc, SerializablePoint2D origLoc, boolean[] origAbove, double origEnergy, double dt ) {
            ...
            if ( bounce || !velocityTowardTrack ) {
                ...
                SimSharingManager.sendModelMessage( skater, bounced, sprite().param( trackIndex, cubicSpline.index ).param( isFloor, cubicSpline instanceof LinearFloorSpline2D ) );
                ...
                SimSharingManager.sendModelMessage( skater, landed, sprite().param( trackIndex, cubicSpline.index ).param( isFloor, cubicSpline instanceof LinearFloorSpline2D ) );

 ...
 */
public class TitrationResources {
    
    private static final PhetResources RESOURCES = new PhetResources( TitrationConstants.PROJECT_NAME );
    
    /* not intended for instantiation */
    private TitrationResources() {}

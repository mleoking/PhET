-injars 'ant_output\jars\bernoulli.jar'
-outjars ant_output\jars\bernoulli-pro.jar
...
-keepclasseswithmembers public class edu.colorado.phet.bernoulli.BernoulliModule{

...
public class TorqueGraphSet extends GraphSuiteSet {
    ...
    public TorqueGraphSet( PhetPCanvas pSwingCanvas, final TorqueModel tm ) {
        ...
        MinimizableControlGraph angleGraph = new MinimizableControlGraph( UnicodeUtil.THETA, new RotationGraph(
                ...
                UnicodeUtil.THETA, "Angular Position", "units", -Math.PI * 3, Math.PI * 3, Color.blue, BufferedSeriesView.DEFAULT_STROKE, new PImage( loadArrow( "blue-arrow.png" ) ),
        ...
        MinimizableControlGraph velocityGraph = new MinimizableControlGraph( UnicodeUtil.OMEGA, new RotationGraph(
                ...
                UnicodeUtil.OMEGA, "Angular Velocity", "units", -0.1, 0.1, Color.red, BufferedSeriesView.DEFAULT_STROKE, new PImage( loadArrow( "red-arrow.png" ) ),
        ...
        MinimizableControlGraph accelGraph = new MinimizableControlGraph( UnicodeUtil.ALPHA, new RotationGraph(
                ...
                UnicodeUtil.ALPHA, "Angular Acceleration", "units", -0.001, 0.001, Color.green, BufferedSeriesView.DEFAULT_STROKE, new PImage( loadArrow( "green-arrow.png" ) ),
        ...
        MinimizableControlGraph torqueGraph = new MinimizableControlGraph( UnicodeUtil.TAU, new RotationGraph(
                ...
                UnicodeUtil.TAU, "torque", "units", -0.001, 0.001, Color.green, BufferedSeriesView.DEFAULT_STROKE, new PImage( loadArrow( "green-arrow.png" ) ),
        ...
        MinimizableControlGraph forceGraph = new MinimizableControlGraph( "F", new RotationGraph(
                ...
                "F", "force", "units", -0.001 / 200.0, 0.001 / 200.0, Color.green, BufferedSeriesView.DEFAULT_STROKE, new PImage( loadArrow( "green-arrow.png" ) ),
        ...
        MinimizableControlGraph momentOfInertiaGraph = new MinimizableControlGraph( "I", new RotationGraph(
                ...
                "I", "Moment of Inertia", "units", -5, 5, Color.green, BufferedSeriesView.DEFAULT_STROKE, new PImage( loadArrow( "green-arrow.png" ) ),
        ...
        MinimizableControlGraph angularMomentumGraph = new MinimizableControlGraph( "L", new RotationGraph(
                ...
                "L", "Angular Momentum", "units", -0.1, 0.1, Color.green, BufferedSeriesView.DEFAULT_STROKE, new PImage( loadArrow( "green-arrow.png" ) ),
                tm, false, tm.getTimeSeriesModel(), null, maxDomainValue, tm.getRotationPlatform() ) );

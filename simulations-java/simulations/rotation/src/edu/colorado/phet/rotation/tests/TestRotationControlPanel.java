...
public class TestRotationControlPanel {
    ...
    public TestRotationControlPanel() {
        ...
        frame.setContentPane( new RotationControlPanel( new RulerNode( 10, 10, new String[0], "units", 3, 14 ), rotationGraphSet, graphSetModel, vectorViewModel, frame, rotationModel.getRotationBody( 1 ), new RotationModule( frame ) ,new AngleUnitModel( true ) ) );
    }

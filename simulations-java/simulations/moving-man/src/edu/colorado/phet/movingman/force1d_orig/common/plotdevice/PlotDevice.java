...
import edu.colorado.phet.movingman.force1d_orig.common_force1d.view.graphics.transforms.ModelViewTransform2D;
import edu.colorado.phet.movingman.force1d_orig.common_force1d.view.phetcomponents.PhetJComponent;
import edu.colorado.phet.movingman.force1d_orig.common_force1d.view.phetgraphics.*;
import edu.colorado.phet.movingman.force1d_orig.common_force1d.view.util.ImageLoader;
import edu.colorado.phet.movingman.force1d_orig.common_force1d.view.util.RectangleUtils;
import edu.colorado.phet.movingman.force1d_orig.force1d_tag_chart.BufferedLinePlot;
import edu.colorado.phet.movingman.force1d_orig.force1d_tag_chart.Chart;
import edu.colorado.phet.movingman.force1d_orig.force1d_tag_chart.DataSet;
import edu.colorado.phet.movingman.force1d_orig.force1d_tag_chart.Range2D;
import edu.colorado.phet.movingman.force1d_orig.force1d_tag_chart.controllers.HorizontalCursor2;
import edu.colorado.phet.movingman.force1d_orig.force1d_tag_chart.controllers.VerticalChartSlider2;
import edu.colorado.phet.movingman.force1d_orig.model.DataSeries;
import edu.colorado.phet.movingman.force1d_orig.model.PhetTimer;
import edu.colorado.phet.movingman.force1d_orig.view.PlotDeviceFontManager;
...
//                BufferedImage image = ImageLoader.loadBufferedImage( "forces-1d/images/x.png" );
                BufferedImage image = ImageLoader.loadBufferedImage( "/simulations/moving-man/data/moving-man/images/x-30.png" );

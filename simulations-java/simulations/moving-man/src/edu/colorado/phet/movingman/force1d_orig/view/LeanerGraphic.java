...
import edu.colorado.phet.movingman.force1d_orig.common_force1d.view.phetgraphics.PhetGraphicListener;
import edu.colorado.phet.movingman.force1d_orig.common_force1d.view.phetgraphics.PhetImageGraphic;
import edu.colorado.phet.movingman.force1d_orig.common_force1d.view.util.BufferedImageUtils;
import edu.colorado.phet.movingman.force1d_orig.common_force1d.view.util.FrameSequence;
...
public class LeanerGraphic extends PhetImageGraphic {
    ...
    public LeanerGraphic( final Force1DPanel forcePanel, final PhetGraphic target ) throws IOException {
        ...
        standingStill = ImageLoader.loadBufferedImage( "/simulations/moving-man/data/moving-man/images/standing-man.png" );

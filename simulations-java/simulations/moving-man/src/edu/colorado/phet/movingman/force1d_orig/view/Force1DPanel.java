...
import edu.colorado.phet.movingman.force1d_orig.common_force1d.view.BasicGraphicsSetup;
import edu.colorado.phet.movingman.force1d_orig.common_force1d.view.ContentPanel;
import edu.colorado.phet.movingman.force1d_orig.common_force1d.view.PhetFrame;
...
import edu.colorado.phet.movingman.force1d_orig.Force1DApplication;
import edu.colorado.phet.movingman.force1d_orig.Force1DUtil;
import edu.colorado.phet.movingman.force1d_orig.common.*;
import edu.colorado.phet.movingman.force1d_orig.common.phetcomponents.PhetButton;
import edu.colorado.phet.movingman.force1d_orig.common.plotdevice.FloatingControl;
import edu.colorado.phet.movingman.force1d_orig.common.plotdevice.PlotDevice;
import edu.colorado.phet.movingman.force1d_orig.common.plotdevice.PlotDeviceModel;
import edu.colorado.phet.movingman.force1d_orig.common.plotdevice.PlotDeviceView;
...
0, SimStrings.get( "Force1DPanel.newtonsAbbrev" ), SimStrings.get( "Force1DPanel.appliedForce" ), true, SimStrings.get( "Force1DPanel.forceWithUnits" ) );
        ...
        Font checkBoxFont = new PhetDefaultFont( Font.PLAIN, 13 );

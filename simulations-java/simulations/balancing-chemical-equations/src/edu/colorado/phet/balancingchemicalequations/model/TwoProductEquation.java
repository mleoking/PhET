...
public abstract class TwoProductEquation extends Equation {
    ...
    protected TwoProductEquation( String name, EquationTerm reactant1, EquationTerm reactant2, EquationTerm product1, EquationTerm product2 ) {
        super( name, new EquationTerm[] { reactant1, reactant2 }, new EquationTerm[] { product1, product2 } );
    }

    protected TwoProductEquation( EquationTerm reactant1, EquationTerm reactant2, EquationTerm product1, EquationTerm product2 ) {
        super( new EquationTerm[] { reactant1, reactant2 }, new EquationTerm[] { product1, product2 } );
    }

    // CH4 + 2 O2 -> CO2 + 2 H2O
    public static class CombustMethaneEquation extends TwoProductEquation {
    ...
    // C2H6 + Cl2 -> C2H5Cl + HCl
    public static class Equation_C2H6_Cl2_C2H5Cl_HCl extends TwoProductEquation {
    ...
    // CH4 + 4 S -> CS2 + 2 H2S
    public static class Equation_CH4_4S_CS2_2H2S extends TwoProductEquation {
    ...
    // CS2 + 3 O2 -> CO2 + 2 SO2
    public static class Equation_CS2_3O2_CO2_2SO2 extends TwoProductEquation {
    ...
    // SO2 + 2 H2 -> S + 2 H2O
    public static class Equation_SO2_2H2_S_2H2O extends TwoProductEquation {
    ...
    // SO2 + 3 H2 -> H2S + 2 H2O
    public static class Equation_SO2_3H2_H2S_2H2O extends TwoProductEquation {
    ...
    // 2 F2 + H2O -> OF2 + 2 HF
    public static class Equation_2F2_H2O_OF2_2HF extends TwoProductEquation {
    ...
    // OF2 + H2O -> O2 + 2 HF
    public static class Equation_OF2_H2O_O2_2HF extends TwoProductEquation {
    ...
    public static class Equation_2C2H6_7O2_4CO2_6H2O extends TwoProductEquation {
    ...
    public static class Equation_2C2H2_5O2_4CO2_2H2O extends TwoProductEquation {
    ...
    public static class Equation_C2H5OH_3O2_2CO2_3H2O extends TwoProductEquation {
    ...
    public static class Equation_4NH3_3O2_2N2_6H2O extends TwoProductEquation {
    ...
    public static class Equation_4NH3_5O2_4NO_6H2O extends TwoProductEquation {
    ...
    public static class Equation_4NH3_7O2_4NO2_6H2O extends TwoProductEquation {
    ...
    public static class Equation_4NH3_6NO_5N2_6H2O extends TwoProductEquation {

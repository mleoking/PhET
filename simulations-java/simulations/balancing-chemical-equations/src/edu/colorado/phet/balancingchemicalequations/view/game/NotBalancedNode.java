...
public class NotBalancedNode extends GamePopupNode {
     ...
     */
    public NotBalancedNode( final Equation equation, boolean closeButtonVisible, boolean titleBarVisible, final boolean whyButtonVisible,
        ...
        super( false /* smile */, closeButtonVisible, titleBarVisible, new Function1<PhetFont, PNode>() {
            public PNode apply( PhetFont font ) {
                ...
                if ( whyButtonVisible ) {
                    showWhyButton = new ButtonNode( BCEStrings.SHOW_WHY, Color.WHITE );
    ...
    public static void main( String[] args ) {
        ...
        NotBalancedNode node = new NotBalancedNode( equation, false, false, true, whyButtonListener, new HorizontalAligner( new Dimension( 475, 400 ), 90 ) );

 ...
 * @author John Blanco
 */
public class ExpSolidLiquidGasCanvas extends PhetPCanvas {
    ...
    private ParticleContainerNode2 m_particleContainer;
    ...
    public ExpSolidLiquidGasCanvas(MultipleParticleModel multipleParticleModel) {

...
public class ExpSolidLiquidGasControlPanel extends ControlPanel {
     ...
     */
    public ExpSolidLiquidGasControlPanel( ExpSolidLiquidGasModule solidLiquidGasModule, Frame parentFrame ) {
            ...
            m_oxygenRadioButton.addActionListener( new ActionListener() {
                public void actionPerformed( ActionEvent e ) {
                    if (m_model.getMolecule() != MultipleParticleModel.DIATOMIC_OXYGEN){
                        ExpSolidLiquidGasControlPanel.this.m_stateSelectionPanel.reset();

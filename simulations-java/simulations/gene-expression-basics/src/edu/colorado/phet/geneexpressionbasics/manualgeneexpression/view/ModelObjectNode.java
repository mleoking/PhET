...
import edu.colorado.phet.geneexpressionbasics.manualgeneexpression.model.ShapeChangingModelObject;
...
public class ModelObjectNode extends PNode {
    public ModelObjectNode( final ModelViewTransform mvt, final ShapeChangingModelObject modelObject, Paint paint ) {

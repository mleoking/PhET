...
class ConcentrationMeterNode extends PhetPNode {
    ...
    private static class BodyNode extends PNode {
        ...
        public BodyNode( final ConcentrationMeter meter ) {
            ...
            final PImage imageNode = new HorizontalTiledNode( bodyWidth, Images.CONCENTRATION_METER_BODY_LEFT, Images.CONCENTRATION_METER_BODY_CENTER, Images.CONCENTRATION_METER_BODY_RIGHT );

 ...
 */
public class FixedObject extends GlaciersObservable {
    ...
    private void setPosition( Point2D position ) {
        throw new UnsupportedOperationException( "position is immutable" );
    }
    ...
    private void setOrientation( double orientation ) {
        throw new UnsupportedOperationException( "orientation is immutable" );
    }
}

...
public abstract class CoilMagnet extends AbstractMagnet {
    ...
    */
     ...
     * @return outputVector
     */
    protected MutableVector2D getBFieldRelative( Point2D p, MutableVector2D outputVector ) {
     ...
     * @param outputVector
     */
    private void getBFieldInside( Point2D p, MutableVector2D outputVector /* output */ ) {
        assert ( p != null );
        assert ( outputVector != null );
    ...
    * @param outputVector
    */
    private void getBFieldOutside( Point2D p, MutableVector2D outputVector /* output */ ) {
        assert ( p != null );
        assert ( outputVector != null );
        assert ( getWidth() == getHeight() );

...
public abstract class AbstractMagnet extends FaradayObservable {
     ...
     */
    public MutableVector2D getBField( final Point2D p ) {
        return getBField( p, new MutableVector2D() );
    }
     ...
     */
    public MutableVector2D getBField( final Point2D p, MutableVector2D outputVector ) {
        assert ( p != null );
     ...
     * @return outputVector
     */
    protected abstract MutableVector2D getBFieldRelative( final Point2D p, MutableVector2D outputVector );

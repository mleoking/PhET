 ...
 */
public class GTL_PS_Points_Challenge extends Challenge {

    public GTL_PS_Points_Challenge( Line answer, ModelViewTransform mvt ) {
    ...
    @Override public PNode createView( LineGameModel model, GameAudioPlayer audioPlayer, PDimension challengeSize ) {
        return new GTL_PS_Points_ChallengeNode( model, audioPlayer, challengeSize );
    }
}

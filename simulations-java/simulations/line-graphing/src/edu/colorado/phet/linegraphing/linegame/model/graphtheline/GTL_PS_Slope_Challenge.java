 ...
 */
public class GTL_PS_Slope_Challenge extends Challenge {

    public GTL_PS_Slope_Challenge( Line answer, ModelViewTransform mvt ) {
    ...
    @Override public PNode createView( LineGameModel model, GameAudioPlayer audioPlayer, PDimension challengeSize ) {
        return new GTL_PS_Slope_ChallengeNode( model, audioPlayer, challengeSize );
    }
}

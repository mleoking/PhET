...
/**
 * Base class drag handler for slope-intercept line manipulators.
 *
 * @author Chris Malley (cmalley@pixelzoom.com)
 */
abstract class SlopeInterceptDragHandler extends SimSharingDragHandler {
    ...
    public SlopeInterceptDragHandler( IUserComponent userComponent, IUserComponentType componentType,
    ...
    public static class InterceptDragHandler extends SlopeInterceptDragHandler {
    ...
    public static class SlopeDragHandler extends SlopeInterceptDragHandler {

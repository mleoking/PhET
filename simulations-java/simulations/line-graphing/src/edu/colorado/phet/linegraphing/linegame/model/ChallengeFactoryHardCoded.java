    ...
    public static ArrayList<IChallenge> createChallenges( int level, IntegerRange xRange, IntegerRange yRange ) {
        ...
        switch( level ) {
            case 1:
                ...
                challenges.add( new GTL_Challenge( DESCRIPTION, Line.createSlopeIntercept( 3, 3, -3 ), LineForm.SLOPE_INTERCEPT, ManipulationMode.POINTS, xRange, yRange ) );
                break;
            case 2:
                ...
                challenges.add( new GTL_Challenge( DESCRIPTION, Line.createPointSlope( 5, 4, 3, 2 ), LineForm.POINT_SLOPE, ManipulationMode.POINTS, xRange, yRange ) );
                break;
            case 3:

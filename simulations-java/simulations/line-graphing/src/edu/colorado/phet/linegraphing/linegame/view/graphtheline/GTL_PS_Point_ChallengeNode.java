 ...
 */
public class GTL_PS_Point_ChallengeNode extends GTL_PS_ChallengeNode {

    public GTL_PS_Point_ChallengeNode( final LineGameModel model, final GameAudioPlayer audioPlayer, PDimension challengeSize ) {

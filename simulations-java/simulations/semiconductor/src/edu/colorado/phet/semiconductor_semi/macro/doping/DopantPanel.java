...
import edu.colorado.phet.common_semiconductor.view.graphics.mousecontrols.DragToCreate;
import edu.colorado.phet.common_semiconductor.view.graphics.mousecontrols.InteractiveGraphicCreator;
...
public class DopantPanel extends CompositeInteractiveGraphic {
    ...
    private void addText( String s, CompositeInteractiveGraphic graphic, PhetVector cell, ModelViewTransform2D transform ) {
        final TextGraphic pText = new TextGraphic( 100, 100, new PhetDefaultFont( Font.PLAIN, 14 ), Color.black, s );

...
class IntroModule(frame: JFrame, clock: ScalaClock) extends BasicRampModule(frame, clock, "forces-and-friction.module.intro.title".translate, false, false, -6, false, 0.0)
class FrictionModule(frame: JFrame, clock: ScalaClock) extends BasicRampModule(frame, clock, "forces-and-friction.module.friction.title".translate, false, false, -6, false, 0.0)
class GraphingModule(frame: JFrame, clock: ScalaClock) extends BasicRampModule(frame, clock, "forces-and-friction.module.graphing.title".translate, false, false, -6, false, 0.0)
class RobotMovingCompany1DModule(frame: JFrame, clock: ScalaClock) extends BasicRampModule(frame, clock, "forces-and-friction.module.robot-moving-company.title".translate, false, false, -6, false, 0.0)

...
class Bead(private var _state: BeadState,
  ...
  val velocityVector = new BeadVector(MotionSeriesDefaults.velocityColor,"Velocity".literal,"velocity",false,()=>getVelocityVectorUnitVector * velocity,(a, b) => b)//todo: translate
  //chain listeners

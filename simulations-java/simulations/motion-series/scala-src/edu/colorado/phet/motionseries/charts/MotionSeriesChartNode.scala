...
//
//    val parallelForceControlGraph = new MotionSeriesGraph(appliedForceSeries, timeseriesModel, updateableObject, model, -2000, 2000) {
...
//        model.bead.parallelAppliedForce_=(appliedForce)
//      }
//    }
...
//    val accelerationGraph = new MotionSeriesGraph(accelerationSeries, timeseriesModel, updateableObject, model, -50, 50) {
...
//    val velocityGraph = new MotionSeriesGraph(velocitySeries, timeseriesModel, updateableObject, model, -25, 25) {
//      addControl(new SeriesSelectionControl(1) {
...
//    val positionGraph = new MotionSeriesGraph(positionSeries, timeseriesModel, updateableObject, model, -10, 10) {
//      addControl(new SeriesSelectionControl(1) {

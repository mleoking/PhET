...
public class CircuitConstructionKitDCApplication extends PhetApplication {
    ...
    public CircuitConstructionKitDCApplication( String[] args ) throws IOException {
        super( new PhetApplicationConfig( args, createFrameSetup(), PhetResources.forProject( "circuit-construction-kit" ), isDynamic( args ) ? "cck-ac" : "cck-dc" ) );
    ...
    private static String readVersion() {
        return PhetApplicationConfig.getVersion( "circuitconstructionkit" ).formatForTitleBar();
    }

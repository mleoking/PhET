...
public class Scene2 extends Scene {
    ...
    private static List<UnaryFunctionNode> unaryFunctionNodeList() {
        return List.list( new UnaryFunctionNode( "\u27152", false, INTEGER_TIMES_2 ) {{ setOffset( 390.72378138847836, 294.298375184638 - 80 ); }},
                          new UnaryFunctionNode( "+1", false, INTEGER_PLUS_1 ) {{ setOffset( 390.72378138847836, 444.298375184638 - 80 ); }}
        );
    }

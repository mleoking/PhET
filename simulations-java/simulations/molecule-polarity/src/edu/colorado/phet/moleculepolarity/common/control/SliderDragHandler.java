 ...
 */
public class SliderDragHandler extends PDragSequenceEventHandler {
     ...
     */
    public SliderDragHandler( Orientation orientation, PNode relativeNode, PNode trackNode, PNode thumbNode, DoubleRange range, VoidFunction1<Double> updateFunction ) {

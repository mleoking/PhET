...
public class PotassiumLeakageChannel extends AbstractLeakChannel {
	...
	private static final double MIN_INTER_PARTICLE_CAPTURE_TIME = 0.0005; // In seconds of sim time.
	private static final double MAX_INTER_PARTICLE_CAPTURE_TIME = 0.005;  // In seconds of sim time.

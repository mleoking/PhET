 ...
 */
public class ParticleNode2 extends PNode {
    ...
    public ParticleNode2( IViewableParticle particle, ModelViewTransform2D modelViewTransform ) {
    ...
    private void createRepresentation() {
        ...
        case SODIUM_ION:
            ...
            representationShape = new Ellipse2D.Double( -transformedRadius, -transformedRadius, transformedRadius * 2, transformedRadius * 2 );
            break;
        ...
        case POTASSIUM_ION:
            ...
            representationShape = AffineTransform.getRotateInstance( Math.PI / 4 ).createTransformedShape( representationShape );
            break;
        ...
        default:
            ...
            representationShape = new Ellipse2D.Double( -defaultSphereRadius, -defaultSphereRadius, defaultSphereRadius * 2, defaultSphereRadius * 2 );
            break;
        }

        representation = new PhetPPath( representationShape, particle.getRepresentationColor(), PARTICLE_EDGE_STROKE, Color.BLACK );
...
//        double pad = 2;
//        parentNode.setPathTo( new Rectangle2D.Double( this.getFullBoundsReference().x - pad, this.getFullBoundsReference().y - pad, this.getFullBoundsReference().width + pad * 2 + STROKE_WIDTH / 2, this.getFullBoundsReference().height + pad * 2 + STROKE_WIDTH / 2 ) );
//

...
public class CoffeeModule extends MicrowaveModule {
    ...
    protected void init() {
        ...
        WaterMolecule[] molecules = new WaterMolecule[MicrowavesConfig.s_numWaterMoleculesInCoffeeCup * 10];
        Box2D oven = getMicrowaveModel().getOven();

        for ( int i = 0; i < MicrowavesConfig.s_numWaterMoleculesInCoffeeCup; i++ ) {

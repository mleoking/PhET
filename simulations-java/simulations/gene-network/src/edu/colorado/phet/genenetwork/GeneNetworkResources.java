 ...
 */
public class GeneNetworkResources {
    
    private static final PhetResources RESOURCES = new PhetResources( GeneNetworkConstants.PROJECT_NAME );
    
    /* not intended for instantiation */
    private GeneNetworkResources() {}

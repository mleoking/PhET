...
public class RadioactiveDatingGameModel implements ModelContainingDatableItems {
    ...
    public RadioactiveDatingGameModel()
    {
    	...
    	_datableObjects.add(new DatableItem(NuclearPhysicsStrings.DATABLE_ITEM_POTTERY, "pottery.png", new Point2D.Double(-18, -1.5), 2.8, Math.PI/2, HalfLifeInfo.convertYearsToMs(5025), true));
    	_datableObjects.add(new DatableItem(NuclearPhysicsStrings.DATABLE_ITEM_ROCK1, "rock_1.png", new Point2D.Double(-6.0, -1.5), 3, 0, HalfLifeInfo.convertYearsToMs(485.3E6), false));
    	...
    	_datableObjects.add(new DatableItem(NuclearPhysicsStrings.DATABLE_ITEM_WOODEN_CUP, "cup.png", new Point2D.Double(8, -2), 1.7,  -Math.PI / 3, HalfLifeInfo.convertYearsToMs(1035), true));
    	...
    	_datableObjects.add(new DatableItem(NuclearPhysicsStrings.DATABLE_ITEM_HUMAN_SKULL, "skull_human.png", new Point2D.Double(-10, -4.5), 2, 1.0, HalfLifeInfo.convertYearsToMs(66E3), true));

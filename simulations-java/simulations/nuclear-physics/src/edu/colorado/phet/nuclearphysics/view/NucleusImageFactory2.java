 ...
 * @author John Blanco
 */
public class NucleusImageFactory2 {
    ...
    private static NucleusImageFactory2 _instance = null;
     ...
     */
    public static NucleusImageFactory2 getInstance(){
        if (_instance == null){
            _instance = new NucleusImageFactory2();
        }
        return _instance;
    }
    ...
    private void addAlpha(PNode nucleus, double radius, double pixelsPerFm){
        ...
        PImage alphaImage;
        alphaImage = new PImage( AlphaParticleModelNode.generateAlphaParticleImage( ALPHA_PARTICLE_DIAMTER ) );
    ...
    private void addNeutron(PNode nucleus, double radius, double pixelsPerFm){
        ...
        // Load the image.
        PImage neutronImage = new PImage(NeutronModelNode.generateNeutronImage( NUCLEON_DIAMETER ));
    ...
    private void addProton(PNode nucleus, double radius, double pixelsPerFm){
        ...
        // Load the image.
        PImage protonImage = new PImage(ProtonModelNode.generateProtonImage( NUCLEON_DIAMETER ));

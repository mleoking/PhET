...
public class BodyNode extends PNode {
    ...
    public BodyNode( final Body body, final ModelViewTransform2D modelViewTransform2D, Property<Boolean> toScaleProperty, final Property<ImmutableVector2D> mousePositionProperty, final PComponent parentComponent ) {

 ...
 */
public class Body {
    private final Property<ImmutableVector2D> positionProperty = new Property<ImmutableVector2D>( new ImmutableVector2D( 0, 0 ) );
    private final Property<Double> diameterProperty = new Property<Double>( 50.0 );

...
public class LiquidDescriptor {
    ...
    public static class WaterDescriptor extends LiquidDescriptor {
        private WaterDescriptor() {
            super(  PHScaleStrings.CHOICE_WATER, 7, new Color( 200, 200, 255, 150 ) );
        }
    }
    public static final WaterDescriptor WATER = new WaterDescriptor();
    
    // singletons for each liquid type
    public static final LiquidDescriptor MILK = new LiquidDescriptor( PHScaleStrings.CHOICE_MILK, 6.5, new Color( 255, 255, 255, 150 ) );
    public static final LiquidDescriptor BEER = new LiquidDescriptor( PHScaleStrings.CHOICE_BEER, 4.5, new Color( 185, 79, 5, 150 ) );
    public static final LiquidDescriptor COLA = new LiquidDescriptor( PHScaleStrings.CHOICE_COLA, 2.5, new Color( 122, 60, 35, 150 ) );
    public static final LiquidDescriptor LEMON_JUICE = new LiquidDescriptor( PHScaleStrings.CHOICE_LEMON_JUICE, 2.4, new Color(255, 255, 0, 150 ) );

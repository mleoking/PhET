...
public class BondAngleNode extends Node {
    ...
    public BondAngleNode( final MoleculeJMEApplication app, MoleculeModel molecule, ImmutableVector3D aDir, ImmutableVector3D bDir, Vector3f transformedDirection, Vector3f lastMidpoint ) {
        super( "Bond Angle" );
        float radius = 5;
        final float alpha = calculateBrightness( aDir, bDir, transformedDirection, molecule.getBondedGroups().size() );
    ...
    public static float calculateBrightness( ImmutableVector3D aDir, ImmutableVector3D bDir, Vector3f transformedDirection, int bondQuantity ) {

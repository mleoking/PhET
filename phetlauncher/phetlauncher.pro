-injars ant_output\jars\phetlauncher.jar
-outjars ant_output\jars\phetlauncher-pro.jar
...
-keepclasseswithmembers public class edu.colorado.phet.launcher.PhETLauncher {

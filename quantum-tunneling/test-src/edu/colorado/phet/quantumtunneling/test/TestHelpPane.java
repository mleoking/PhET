...
public class TestHelpPane extends PhetApplication {
    ...
    {
        super( args, "TestHelpPane", "description", "0.1", new FrameSetup.CenteredWithSize( 1024, 768 ) );
        
        IClock clock1 = new SwingClock( 1000 / CLOCK_RATE, new TimingStrategy.Constant( MODEL_RATE ) );
        Module module1 = new TestModule( "Module1", clock1 );
        addModule( module1 );
        
        IClock clock2 = new SwingClock( 1000 / CLOCK_RATE, new TimingStrategy.Constant( MODEL_RATE ) );
        Module module2 = new TestModule( "Module2", clock2 );
        addModule( module2 );
    }
    ...
    private static class TestModule extends PiccoloModule {
        ...
        public TestModule( String title, IClock clock ) {
            super( title, clock, true /* startsPaused */ );
            ...
            // Help
            {
                ...
                HelpBalloon h1 = new HelpBalloon( helpPane, "Press to reset everything", HelpBalloon.RIGHT_CENTER, 40 );
                helpPane.add( h1 );
                h1.pointAt( resetButton );  
            }
        }

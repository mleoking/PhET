...
/** 
 * LightbulbRescaler is used to rescale the lightbulb intensity.
 * The reference is the magnetic field of a magnet.
 *
 * @author Chris Malley (cmalley@pixelzoom.com)
 * @version $Revision$
 */
public class LightbulbRescaler extends GenericRescaler implements SimpleObserver {
     ...
     */
    public LightbulbRescaler( AbstractMagnet magnetModel ) {
        super();

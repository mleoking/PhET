...
package edu.colorado.phet.faraday.coreadditions;
 ...
 * RadialGradientPaint
 * <p>
 * This class was adapted from the RoundGradialPaint class in
 * Jonathan Knudsen's "Java 2D" (First Edition), published by O'Reilly and Associates.
 * 
 * @version $Revision$
 */
public class RadialGradientPaint implements Paint {
    ...
    public RadialGradientPaint( double x, double y, Color pointColor, Point2D radius, Color backgroundColor ) {
    ...
    public PaintContext createContext( ColorModel cm, Rectangle deviceBounds, Rectangle2D userBounds, AffineTransform xform, RenderingHints hints ) {
        ...
        return new RadialGradientContext( transformedPoint, mPointColor, transformedRadius, mBackgroundColor );
    }
    ...
    public class RadialGradientContext implements PaintContext {
        ...
        public RadialGradientContext( Point2D p, Color c1, Point2D r, Color c2 ) {
            mPoint = p;
            mC1 = c1;
            mRadius = r;
            mC2 = c2;

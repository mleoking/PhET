...
//        add( new GrabBagItem( getClass().getClassLoader().getResource( "dog.gif" ), SimStrings.get( "GrabBag.Dog" ), Math.pow( 10, 9 ), 2.5 ) );
        ...
        add( new GrabBagItem( "paperclip.gif", SimStrings.get( "GrabBag.PaperClip" ), CCK3Module.MIN_RESISTANCE, .7 ) );
        add( new GrabBagItem( "penny.gif", SimStrings.get( "GrabBag.Penny" ), CCK3Module.MIN_RESISTANCE, .6 ) );

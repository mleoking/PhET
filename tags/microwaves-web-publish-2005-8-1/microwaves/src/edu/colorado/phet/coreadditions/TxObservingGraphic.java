...
public abstract class TxObservingGraphic implements ObservingGraphic, TransformListener {
    ...
    protected void setBoundsMapping( Rectangle2D.Double modelBounds,
                                         ...
                                         edu.colorado.phet.common.view.ApparatusPanel apparatusPanel ) {
...
//        modelViewTx = new ModelViewTransform2D( modelBounds, viewBounds );
    ...
    class ApparatusPanelModelViewTxAdapter extends ComponentAdapter {
        ...
        ApparatusPanelModelViewTxAdapter( ModelViewTransform2D tx, edu.colorado.phet.common.view.ApparatusPanel apparatusPanel ) {

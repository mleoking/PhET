...
public class ControlZGridPlot extends ControlDrawable2D implements org.opensourcephysics.ejs.control.swing.NeedsPreUpdate {
  ...
  public ControlZGridPlot(Object _visual) {
    super(_visual);
  }
  ...
  protected org.opensourcephysics.display.Drawable createDrawable(Object _drawable) {
    ...
    dataArray = null;
    if(_drawable instanceof GridPlot) {
      plot = (GridPlot) _drawable;
      plot.setGridData(pointdata);
    } else {
      plot = new GridPlot(pointdata);
    }
    minX = -1.0;
    maxX = 1.0;
    minY = -1.0;

...
public class ControlSiteLattice extends ControlDrawable2D {
  ...
  public ControlSiteLattice(Object _visual) {
    super(_visual);
  }

  protected Drawable createDrawable(Object _drawable) {
    if(_drawable instanceof SiteLattice) {
      lattice = (SiteLattice) _drawable;
    } else {
      lattice = new SiteLattice(21, 21);
  ...
  public void setValue(int _index, Value _value) {
    ...
    case 4 :
      if(_value.getObject() instanceof int[][]) {
        ...
        // replaceDrawable (new EjsBinaryLattice(nx=data.length,ny=data[0].length),data); else

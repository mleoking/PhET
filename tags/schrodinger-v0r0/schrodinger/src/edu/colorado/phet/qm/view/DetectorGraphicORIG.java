...
public class DetectorGraphicORIG extends GraphicLayerSet {
    ...
    public DetectorGraphicORIG( SchrodingerPanel component, final Detector detector ) {
        super( component );
        ...
        detector.addObserver( new SimpleObserver() {
            public void update() {
                DetectorGraphicORIG.this.update();
            }
        } );
        update();
    }

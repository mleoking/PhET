...
public class HollowSphereApparatusPanel extends BaseIdealGasApparatusPanel {

    private HollowSphere sphere;
    private HollowSphereControlPanel hsaControlPanel;

    public HollowSphereApparatusPanel( PhetApplication application ) {
        super( application, "Rigid Hollow Sphere" );
    }
...
//        for( int i = 0; i < 0; i++ ) {
        ...
        // Put some light gas in the sphere
        Particle p1 = null;
//        int num = 0;
        int num = 4;
        int sign = 1;

...
import edu.colorado.phet.common.view.graphics.mousecontrols.DragToCreate;
import edu.colorado.phet.common.view.graphics.mousecontrols.InteractiveGraphicCreator;
...
public class DopantPanel extends CompositeInteractiveGraphic {
    ...
    public DopantPanel( final ApparatusPanel apparatusPanel, final ModelViewTransform2D transform, final BufferedImage nDopantImage, BufferedImage pDopantImage, final Rectangle2D.Double modelRect ) throws IOException {
        ...
        Border bo = BorderFactory.createTitledBorder( init, "Dopants", 0, 0, font, Color.black );
        ...
        addText( "P Type", positive, rightCell, transform );
        addText( "N Type", negative, leftCell, transform );

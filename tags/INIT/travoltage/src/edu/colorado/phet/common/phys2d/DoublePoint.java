...
public class DoublePoint {
    ...
    public static DoublePoint average( DoublePoint[] dp ) {
        edu.colorado.phet.common.phys2d.util.Averager x = new edu.colorado.phet.common.phys2d.util.Averager();
        edu.colorado.phet.common.phys2d.util.Averager y = new edu.colorado.phet.common.phys2d.util.Averager();

...
import edu.colorado.phet.common.ParticleList;
...
public class ForceLawPropagator extends ParticleList implements Propagator {
    ...
    public void propagate( double dt, Particle p ) {
        //edu.colorado.phet.common.util.Debug.traceln(force);
        //f=ma
        ...
        //edu.colorado.phet.common.util.Debug.traceln("oldacc="+oldAcc+", newacc="+newAcc);

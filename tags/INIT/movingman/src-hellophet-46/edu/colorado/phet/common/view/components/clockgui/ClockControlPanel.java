...
public class ClockControlPanel extends JPanel implements ClockStateListener {
    ...
    public ClockControlPanel(Clock clock) {
        ...
        spinnerModelDT = new SpinnerNumberModel(clock.getDt(), 0.0, 100.0, 0.05);
        spinnerModelWT = new SpinnerNumberModel(clock.getWaitTime(), 0, 1000, 5);
...
//        init(clock);
    ...
    private void syncPanelToClock() {
        ...
        waitTimeSpinner.setValue(new Integer(clock.getWaitTime()));
    }
    ...
    private static class ThreadPriorityPanel extends JPanel {
        ...
        public ThreadPriorityPanel(final Clock c) {
            this.c = c;
    ...
    private void updateClockWaitTime() {
        this.clock.setWaitTime(getSleepInterval());
    }

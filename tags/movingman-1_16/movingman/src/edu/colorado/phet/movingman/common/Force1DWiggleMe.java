...
//    private double frequency = 0.0025;//in Hertz.
    ...
    public Force1DWiggleMe( Component component, AbstractClock clock, String text, PhetGraphic phetGraphic ) {
...
//        System.out.println( "tick" );
        if( isVisible() && getComponent().isShowing() ) {
            ...
            Point oscillationCenter = getOscillationCenter( targetLoc );

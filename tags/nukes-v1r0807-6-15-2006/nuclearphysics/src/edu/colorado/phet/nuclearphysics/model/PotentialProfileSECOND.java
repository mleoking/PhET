 ...
 */
public class PotentialProfileSECOND extends SimpleObservable implements SimpleObserver {
    ...
    public PotentialProfileSECOND( Nucleus nucleus ) {
    ...
    public PotentialProfileSECOND( double width, double maxPotential, double wellDepth ) {
        this.width = width;
